...
M=[("DONMUŞ DEPO",700),("TAZE DOLAP",700),("PRES",700),("DOZAJ",700),("FIRIN",650),("KESİM+KUTU",700),("İÇECEK",600)]
...
xs=[X0+px(sum(w for _,w in M[:i])) for i in range(8)]
...
rc(a0+px(60),Y0+px(370),a1-a0-px(120),px(1410),1)
for kz in range(19):
    ln(a0+px(60),Y0+px(420)+kz*px(70),a0+px(85),Y0+px(420)+kz*px(70),.8)
    ln(a1-px(85),Y0+px(420)+kz*px(70),a1-px(60),Y0+px(420)+kz*px(70),.8)
for r in range(10):
    ty=Y0+px(560)+r*px(126)
    ln(a0+px(72),ty,a1-px(72),ty,1.2)
    ln(a0+px(72),ty,a0+px(72),ty-px(20),1.2); ln(a1-px(72),ty,a1-px(72),ty-px(20),1.2)
    rc((a0+a1)/2-px(80),ty+px(5),px(160),px(14),.9,2)
    for i in range(4): ci(a0+px(130)+i*px(125),ty-px(48),px(46),1)
not_((a0+a1)/2,Y0+px(58),"soğutma ×2 — −18 °C")
not_((a0+a1)/2,Y0+px(345),"DONMUŞ ANA DEPO · 10 raf × 20 ≈ 200 top")

# A2 TAZE DOLAP + ILIK 700
a2,a3=xs[1],xs[2]
rc(a2+8,Y0+px(10),a3-a2-16,px(290),1.6)
ci(a2+px(190),Y0+px(140),px(80),1.2); ci(a2+px(510),Y0+px(140),px(80),1.2)
ln(a2+px(150),Y0+px(100),a2+px(230),Y0+px(180),.9); ln(a2+px(150),Y0+px(180),a2+px(230),Y0+px(100),.9)
ln(a2+px(470),Y0+px(100),a2+px(550),Y0+px(180),.9); ln(a2+px(470),Y0+px(180),a2+px(550),Y0+px(100),.9)
for g in range(4): ln(a2+20,Y0+px(225)+g*px(15),a3-20,Y0+px(225)+g*px(15),.7)
ln(a2+15,Y0+px(310),a3-15,Y0+px(310),1)
...
rc(a2+8,Y0+px(600),a3-a2-16,px(840),1.8)
rc(a2+px(60),Y0+px(655),a3-a2-px(120),px(730),1)
for kz in range(10):
...
rc(a2+8,Y0+px(1450),a3-a2-16,px(390),1.8)
for r in range(7): ln(a2+px(80),Y0+px(1530)+r*px(38),a3-px(80),Y0+px(1530)+r*px(38),1)
not_((a2+a3)/2,Y0+px(345),"ılık AÇIK raf · 2×4")
not_((a2+a3)/2,Y0+px(638),"TAZE +3 °C · 5 raf × 20 ≈ 100 · çukurlu tepsi")
not_((a2+a3)/2,Y0+px(1490),"boş tepsi iadesi — teslimatçı değiştirir")

# B PRES 700 (PZP-400 64x80x95)
b0,b1=xs[2],xs[3]; bm=(b0+b1)/2
...
not_((a0+a3)/2,YT2+px(45),"iki kabin: donmuş depo + taze dolap · tepsi 4×5=20 · kapılar + yay")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v12 · MODÜLER · 475 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · HAFTADA 2 TESLİMAT: donmuş depo 200 + taze 100 + ılık 8 ≈ 310 top · bağımsız kabinler · kapılar çıkarılmış · ayak 12",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v12.svg"
