...
M=[("HAMUR",700),("PRES",700),("DOZAJ",650),("FIRIN",650),("KESİM+KUTU",700),("İÇECEK",550)]
...
# A HAMUR 600 — bolmeler 30/84/59; raf araligi HER YERDE 130-140
a0,a1=xs[0],xs[1]
rc(a0+8,Y0+px(10),a1-a0-16,px(290),1.6)                           # MOTOR bolmesi (standart ust grup)
ci(a0+px(190),Y0+px(140),px(80),1.2); ci(a0+px(510),Y0+px(140),px(80),1.2)
ln(a0+px(150),Y0+px(100),a0+px(230),Y0+px(180),.9); ln(a0+px(150),Y0+px(180),a0+px(230),Y0+px(100),.9)
ln(a0+px(470),Y0+px(100),a0+px(550),Y0+px(180),.9); ln(a0+px(470),Y0+px(180),a0+px(550),Y0+px(100),.9)
for g in range(4): ln(a0+20,Y0+px(225)+g*px(15),a1-20,Y0+px(225)+g*px(15),.7)
ln(a0+15,Y0+px(310),a1-15,Y0+px(310),1)                           # ILIK ACIK RAF (kapaksiz)
ln(a0+15,Y0+px(590),a1-15,Y0+px(590),1)
ln(a0+px(70),Y0+px(448),a1-px(70),Y0+px(448),1)
for i in range(5): ci(a0+px(110)+i*px(107),Y0+px(395),px(50))
for i in range(5): ci(a0+px(110)+i*px(107),Y0+px(538),px(50))
# BUZDOLABI 600-1440: 60mm PU duvar cift cizgi + kizak + kenarli tepsi
rc(a0+8,Y0+px(600),a1-a0-16,px(840),1.8)
rc(a0+px(60),Y0+px(655),a1-a0-px(120),px(730),1)                  # ic hacim (60 duvar)
for kz in range(10):                                              # kizak disleri
    ln(a0+px(60),Y0+px(700)+kz*px(70),a0+px(85),Y0+px(700)+kz*px(70),.8)
    ln(a1-px(85),Y0+px(700)+kz*px(70),a1-px(60),Y0+px(700)+kz*px(70),.8)
for r in range(5):                                                # kenarli tepsiler (U) + toplar + surucu
    ty=Y0+px(795)+r*px(140)
    ln(a0+px(72),ty,a1-px(72),ty,1.2)
    ln(a0+px(72),ty,a0+px(72),ty-px(22),1.2); ln(a1-px(72),ty,a1-px(72),ty-px(22),1.2)
    rc((a0+a1)/2-px(80),ty+px(6),px(160),px(16),.9,2)
    for i in range(5): ci(a0+px(110)+i*px(107),ty-px(52),px(50),1)
# REZERV 1440-1850
rc(a0+8,Y0+px(1450),a1-a0-16,px(390),1.8)
rc(a0+px(60),Y0+px(1500),a1-a0-px(120),px(290),1)
for r in range(2):
    ty=Y0+px(1638)+r*px(140)
    ln(a0+px(72),ty,a1-px(72),ty,1.2)
    ln(a0+px(72),ty,a0+px(72),ty-px(22),1.2); ln(a1-px(72),ty,a1-px(72),ty-px(22),1.2)
    rc((a0+a1)/2-px(80),ty+px(6),px(160),px(16),.9,2)
    for i in range(5): ci(a0+px(110)+i*px(107),ty-px(52),px(50),1)
not_((a0+a1)/2,Y0+px(58),"soğutma grupları ×2 — standart üst bölme")
not_((a0+a1)/2,Y0+px(345),"ılık AÇIK raf · 2×5 top")
not_((a0+a1)/2,Y0+px(638),"60 mm PU duvar · teleskopik ray + raf altı 24V sürücü — 5 raf ≈150")
not_((a0+a1)/2,Y0+px(1487),"rezerv −18° · 2 raf ≈60")
tx(a0+14,Y0+px(80),"29",9.5,"start","", "#555"); tx(a0+14,Y0+px(360),"28",9.5,"start","", "#555"); tx(a0+14,Y0+px(628),"84",9.5,"start","", "#555"); tx(a0+14,Y0+px(1478),"39",9.5,"start","", "#555")
...
rc(X0,YT2,px(T),px(840),2.2,6)
for i in range(1,6): ln(xs[i],YT2,xs[i],YT2+px(840),1.6)

# HAMUR: tepsi 53x65 derinlemesine, 5x6 top
rc(a0+px(60),YT2+px(60),a1-a0-px(120),px(700),1)                  # ic hacim (60 duvar)
rc(a0+px(85),YT2+px(85),px(530),px(650),1.4)                      # GN tepsi 53 cephe x 65 derin
ln(a0+px(75),YT2+px(85),a0+px(75),YT2+px(735),1); ln(a0+px(68),YT2+px(85),a0+px(68),YT2+px(735),.7)
ln(a1-px(75),YT2+px(85),a1-px(75),YT2+px(735),1); ln(a1-px(68),YT2+px(85),a1-px(68),YT2+px(735),.7)
for j in range(6):
    for i in range(5): ci(a0+px(112)+i*px(107),YT2+px(140)+j*px(108),px(50),1)
rc(a0+px(20),YT2+px(770),a1-a0-px(40),px(60),1.4)                 # kapi 60mm
ci(a1-px(40),YT2+px(800),px(14),1.2)                              # mentese
E.append(f'<path d="M {a0+px(20):.1f} {YT2+px(800):.1f} A {a1-a0-px(60):.1f} {a1-a0-px(60):.1f} 0 0 1 {a1-px(40):.1f} {YT2+px(800)+(a1-a0-px(60)):.1f}" fill="none" stroke="#111" stroke-width="1" stroke-dasharray="5 4"/>')
not_((a0+a1)/2,YT2+px(45),"tepsi 53×65 · yanlarda teleskopik ray · kapı 6 cm + yay")
...
ci(c0+px(170),YT2+px(620),px(140),1.6); ci(c0+px(470),YT2+px(620),px(140),1.6)
...
tx(X0,Y0-70,"AUTOKITCH — HAT v9 · ÖN + ÜST GÖRÜNÜŞ · 395 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · iç yapı STANDART: 60 mm PU panel · 0,8 paslanmaz · GN kızak+tepsi · kapılar çıkarılmış görünüş · ayak 12 · CP-330 ile 385",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v9.svg"
