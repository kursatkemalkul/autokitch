...
tx(X0,Y0-70,"AUTOKITCH — HAT v22 · SOĞUK DEPO 2 KAPI · 415 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · ILIK RAF KALKTI (ısıtmalı PZP-400: dolaptan prese direkt; fırın süresi reçeteyle +15-30 sn) · raf aralığı 13,8'e ferahladı · TAZE 160=2G · DONMUŞ 80=1G · ayak 12",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v22.svg"
