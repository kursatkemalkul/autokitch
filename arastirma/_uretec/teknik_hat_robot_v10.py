# -*- coding: utf-8 -*-
"""AUTOKITCH - HAT v10 (ilk cizime sadik: cekmeceler istasyon altlarinda, onde YER RAYI + TEK ROBOT) (16 Eyl 2026): iki robot, bant yok, 3 gozlu kaviteli firin (2 lahmacun alt alta + 1 pide).
...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_ROBOT_v10_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 5200, 2960
...
def on_gorunus(OX, ZY, S):
    ...
    # araba + kaide + robot
    cx = R1X
    d.rectangle([px(cx - 220), pz(360.0), px(cx + 220), pz(220.0)], fill=None, outline=ACC, width=3)
    txt(px(cx), pz(290.0), "ARABA", f8, ACC, "mm")
    d.rectangle([px(cx - 90), pz(OMUZ - 60), px(cx + 90), pz(360.0)], fill=None, outline=ACC, width=3)
    txt(px(cx) + 104, pz(760.0), "KAİDE 1040", f8, ACC, "lm")
    ...
    d.rectangle([px(R2X - 220), pz(360.0), px(R2X + 220), pz(220.0)], fill=None, outline=GRAY, width=2)
...
# ======================= SAYFA =======================
txt(210, 92, "AUTOKITCH · HAT v10 · YER RAYI + TEK ROBOT · 3 GÖZLÜ FIRIN", f34, INK)
