...
W, H = 1560, 1180
tx(40,44,'İSTASYON 3 — TOPPING · DETAY v6 (kaset kapasiteleri 3 günlük: kaşar ~20 kg · diğerleri 4-5 kg)',17,'start','bold')
...
kaset(X0+px(25),Y0+px(60),px(325),px(350),'H1 KÜP SUCUK','kaset ≈50 L · 4-5 kg = 3 gün')
kaset(X0+px(350),Y0+px(60),px(325),px(350),'H2 KAŞAR','kaset ≈50 L · ~20 kg = 3 gün')
...
nots = [
 ...
 ('  kazanılan yer → kaset 35 cm ≈ 50 L','#666'),
 ('· Kaset = 3 GÜNLÜK stok: kaşar ~20 kg','#333'),
 ('  (6,4 kg/gün) · sucuk/kavurma/kuşbaşı','#666'),
 ('  4-5 kg · dolum fırıncıyla aynı sabah','#666'),
...
tx(W-24,H-14,'AUTOKITCH · ist3_topping_detay_v6',10,'end','','#999')
...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\3_TOPPING\ist3_topping_detay_v6.svg"
