...
import os, pythoncom
from sw_lib import *
R = r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\7_SERVICE_v1"
sw.CloseAllDocuments(True)
e = VARIANT(pythoncom.VT_BYREF|pythoncom.VT_I4, 0); w = VARIANT(pythoncom.VT_BYREF|pythoncom.VT_I4, 0)
d = sw.OpenDoc6(os.path.join(R, "SERVICE_v1.SLDASM"), 2, 1, "", e, w); mcall(d, "EditRebuild3")
out = []
def gez(c):
...
n1 = kes(("panel_", "kilit_silindiri", "ust_cephe_seridi"),
         [("SERVICE_v1_ic_iso.png", "*Isometric"), ("SERVICE_v1_ic_on.png", "*Front")])
# 2) ayrica sag yan duvar + sove gizli -> yandan kesit gibi bakis
n2 = kes(("dis_yan_sag", "ic_yan_sag", "sove_sag", "dis_ust", "ic_tavan"),
         [("SERVICE_v1_ic_yan.png", "*Right")])
