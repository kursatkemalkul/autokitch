...
# ================= 5 PACK v49 (kesim OVEN'e taşındı · şarjör 116 · kutulama) =================
...
# PACK ust v49: kutulama yuvası önde (tepsi Ø32 + açık kutu), şarjör 2×2 arkada (kesik); kesim yok
...
_ki=len(E)
tx(kx,ky,"KONTROL — istasyonlar arası uyum (6 Eyl 2026, HAT v49)",12,"start","bold","#b3452b")
K=[
...
tx(X0,Y0-94,"AUTOKITCH — HAT v49 · TÜM İSTASYONLAR SON VERSİYON (6 Eyl 2026) — STORE v4 (+ v5 öneri) · PRESS v8 · TOPPING v25 yerleşim + v27 KAP · OVEN v4 (Omake 2 kat · 2 STANDART YAĞ KABI + sprey ortada · KESME PRESİ · kolon 70) · PACK = şarjör 116 + kutulama",15,"start","bold")
...
tx(X0,Y0-54,"Ölçüler cm. HER KABİN 70/140 × 197 × 84 (gövde 185 + ayak 12; TOPPING ve OVEN'de ayak yerine plint 12 = ızgara). Açık: ⑤ Fersah Ø30 taban · ⑦ kol yükü 15,2 kg + menzil · ⑫ robot tepsi eli v2 (kulp 6) · ① STORE v5 onayı · TOPPING prototipleri (spiral 11, kaşar akışı, çatal-cep hizası) · OVEN v4: kesme kuvveti pilotu · sadeyağ mı sıvı yağ mı · kuru bağlantı tipi",10,"start","","#333")
...
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\FULL_MAKINE\hat_on_gorunus_teknik_v49.svg"
