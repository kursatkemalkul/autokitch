# -*- coding: utf-8 -*-
"""AUTOKITCH - A1 YERLESIM v2 (16 Eyl 2026): iki sabit Fairino robot. UST GORUNUS x2 (alt alta) + ORTAK ON GORUNUS.
...
v1'e gore: planlar alt alta, erisim cemberleri acik tonda, olculer ve on gorunus duzeltildi.
Kural: paftada yalniz gorunus + olcu + parca adi; aciklama mesajda. Olculer mm.
"""
import os, math
from PIL import Image, ImageDraw, ImageFont

OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_A1_v2_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 5400, 3150
...
def plan(OX, OY, cfg):
    ...
    txt(rx - 18, ry - 30, "ROBOT 1", f9, ACC, "rb")
    txt(rx - 18, ry - 8, "FR5 · 922", f8, ACC, "rb")
    ...
    txt(qx + 18, qy - 30, "ROBOT 2", f9, ACC, "lb")
    txt(qx + 18, qy - 8, cfg["ad"].split(" · ")[0], f8, ACC, "lb")
    ...
    olcu_h(a[0], b[0], b[1] + 62, cfg["ayak"][4], f11)
...
# ======================= SAYFA =======================
txt(210, 92, "AUTOKITCH · A1 YERLEŞİM v2 · İKİ SABİT ROBOT", f34, INK)
txt(210, 152, "üst görünüş ×2  ·  ortak ön görünüş  ·  ölçüler mm  ·  16 Eylül 2026", f13, GRAY)

OX0 = 210 + 845 * SC
plan(OX0, 500 + DER * SC, SEC[0])
plan(OX0, 1900 + DER * SC, SEC[1])
...
olcu_v(fx(KX - 300.0), FY, fy(1366.0), "OMUZ 1366", yon="l")
...
olcu_v(fx(KX + 1170.0) + 46, FY, fy(1915.0), "1915")
