# -*- coding: utf-8 -*-
"""AUTOKITCH · KIYMA AKIŞ MODELİ v1 (22 Eyl 2026) — macun TANE DEĞİL: serpilmez, ŞERİT olarak serilir. Matematiği süreklilik:
...
G = dict(RT=30.0, C=2.0, R_MIL=9.0, R_KOK=15.0, T=3.0, P0=36.0, P1=48.48, ETAF=0.40)
