# -*- coding: utf-8 -*-
"""AUTOKITCH - TABLALI HAT · OPTIMUM v1 (14 Eyl 2026): ON + UST GORUNUS. Olculer mm.
Kemal: "5200 cok, gercek hayatta devasa; bos yerleri bul, en optimum sekilde yeniden cik".
Tespit: boyu ustteki istasyonlar degil hat altindaki STORE belirliyor (6 cekmece/kolon -> 36 cekmece 6 kolon ~ 3,9 m) + bastaki yedek/TEKNIK kolonu.
DEGISIKLIKLER (5298 -> 4175, -1123):
  yedek + TEKNIK kolonu kalkti (-655): yedek malzeme hazne yerine vakum paket, 4 cekmece; sogutma grubu split (dis unite disarida), hat panosu KESME ustunde
  Atosa uyarlama 1143 -> 885 (-258): 1 gunluk 7 hazne iki dengeli sira (on KASAR + HARC 765 · arka HARC KIYMA KUS KUS SUC 815)
  firin adim 350 -> 330, hazne 1400 -> 1320, modul 1420 (-80): 4 urun, 240 s, 60/saat ayni (bant 5,5 mm/s, urun arasi 30)
  KESME 600 -> 500 (-100): plaka 460 x 450, kesici O320 · PRES 700 -> 670 (-30): Fersah 640 + 2 x 15
STORE: cekmece adimi 121 -> 111 (cerceve 15 -> 10), kaide 120 -> 80 -> kolon basina 8 cekmece; hat kotu +105 (tabla/bant 1405, yukseklik 2075)
  5 kolon x 8 = 40: pide 12 · lahmacun 20 · icecek 4 · yedek malzeme paketi 4 (2 gun). Yukseklik ayni kalsaydi 7 cekmece/kolon -> 6 kolon, hat ~4660.
Kural: paftada yalniz gorunus + olcu + parca adi; aciklama mesajda.
"""
import os, math
from PIL import Image, ImageDraw, ImageFont

OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_OPTIMUM_v1_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 3700, 2800
S, S2 = 0.62, 0.80
...
YW = 0.0                                              # yedek kaset dolabi 620 + bolme 35 (hat basinda)
X0, _x = {}, YW
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  TABLALI HAT  ·  OPTİMUM  ·  v1", f38, INK)
txt(OX, 138, "ön görünüş + üst görünüş  ·  hat 4175 × 2075 × 830  ·  tam 3 gün stok  ·  Atosa uyarlama 885: 1 günlük 7 hazne  ·  STORE 5 kolon × 8 çekmece  ·  ölçüler mm  ·  14 Eylül 2026", f13, GRAY)
...
XI, WO, BOL = 35.0, 620.0, 35.0
HHK = {"hamur": 88.0, "lahm": 88.0, "paket": 88.0, "icecek": 88.0}
ADK = {"hamur": "TAZE PİDE", "lahm": "LAHMACUN", "paket": "YEDEK MALZEME · 2 gün", "icecek": "İÇECEK"}
CAPK = {"hamur": (20, "top"), "lahm": (30, "top"), "paket": (None, "vakum"), "icecek": (52.5, "kutu")}
KOLON = [(1005.0, [(8, "hamur")]), (1005.0, [(4, "hamur"), (4, "lahm")]), (1005.0, [(8, "lahm")]), (1005.0, [(8, "lahm")]), (1005.0, [(4, "icecek"), (4, "paket")])]
cx = X0["PRESS"] + XI
...
txt(fx(kx0 + 250), fy((2073.0 + Y_BANT + 430.0) / 2), "HAT PANOSU · TAHRİK", f8, INK, "mm")
# --- PACK
pk0 = X0["PACK"]
...
txt(W_PX - 170, ly + 34, "HAT %s × 2075 × 830  ·  TOPPING Atosa uyarlama 885 · 7 hazne (1 gün)  ·  OVEN 1420 · 4 ürün  ·  STORE %d çekmece (3 gün + 2 günlük yedek malzeme)" % (sayi(HAT), CEK), f9, GRAY, "rm")

assert not os.path.exists(OUT), "optimum v1 zaten var — yeni numara ver"
