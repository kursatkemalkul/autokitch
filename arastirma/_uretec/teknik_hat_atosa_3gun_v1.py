# -*- coding: utf-8 -*-
"""AUTOKITCH - TABLALI HAT · TAM 3 GUN · ATOSA'DA 1 GUNLUK SET + YEDEK DOLAPTA 2 GUNLUK SET v1 (14 Eyl 2026): ON + UST GORUNUS. Olculer mm.
Kemal: "her sey tam 3 gunluk olsun, pay yok (3,8 / 7,8 degil); yedek kasetler dolaba sigmiyor mu, 3 gunluk pide + lahmacun hamuru ve iceceklerle?"
HAZNE: her hazne TAM 1 GUNLUK doldurulur -> harc 2 x 11 kg · kiyma 3,2 · kusbasi 2 x 1,45 · kasar 4,4 · sucuk 1,4 (7 hazne = 1 set).
  Atosa'da 1 set, yedek dolapta 2 set (14 hazne: sos 6 · peynir 2 · topping 6) = tam 3 gun. Her gun bir set degisir.
STORE TAM 3 GUN: pide 80 x 3 = 240 -> 12 cekmece x 20 · lahmacun 200 x 3 = 600 -> 20 x 30 · icecek 70 x 3 = 210 -> 4 cekmece (56'lik) = 36 cekmece.
  Hat altinda 6 kolon x 6 cekmece = 36: ancak TEKNIK hat altindan cikarsa sigar (XI 0, K6 bitisi PACK'e 48 mm).
  Hazne (360 yuksek) 88'lik cekmeceye girmez, hat altinda yer de kalmaz -> yedek hazneler hat basindaki kolonda 3 rafta, TEKNIK ayni kolonun ustunde (620 x 635).
Hat boyu degismedi: 655 + 4643 = 5298.
Kural: paftada yalniz gorunus + olcu + parca adi; aciklama mesajda.
"""
import os, math
from PIL import Image, ImageDraw, ImageFont

OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_ATOSA_3GUN_v1_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 4000, 2800
S, S2 = 0.62, 0.80
...
# ======================= VERI =======================
H = 1970.0
ISTASYON = [("PRESS v7", 700.0), ("TOPPING · Atosa · 1 günlük set", 1143.0), ("OVEN v7 · özel konveyör", 1500.0), ("KESME v1", 600.0), ("PACK v5", 700.0)]
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  TABLALI HAT  ·  TAM 3 GÜN  ·  ATOSA 1 GÜN + YEDEK DOLAP 2 GÜN  ·  v1", f38, INK)
txt(OX, 138, "ön görünüş + üst görünüş  ·  her hazne tam 1 günlük dolu: Atosa'da 1 set (7 hazne), yedek dolapta 2 set (14 hazne) = tam 3 gün  ·  STORE tam 3 gün: 12 pide + 20 lahmacun + 4 içecek çekmecesi  ·  830 derin  ·  ölçüler mm  ·  14 Eylül 2026", f13, GRAY)
...
KOLON = [(940.0, [(6, "hamur")]), (900.0, [(6, "hamur")]), (900.0, [(6, "lahm")]), (900.0, [(6, "lahm")]), (900.0, [(6, "lahm")]), (900.0, [(2, "lahm"), (4, "icecek")])]
cx = X0["PRESS"] + XI
...
txt(fx(310), fy((H + YH) / 2) - 24, "TEKNİK  620 × 635", f8, GRAY, "mm")
...
d.rectangle([fx(620), fy(H), fx(YW), fy(120.0)], fill=SOFT, outline=LINE, width=1)
...
for x_, w_, ad_, tip_ in ONX:
    ...
    txt(fx(cx_), fy(1600.0), DOLUM[ad_], f7, RED, "mm")
...
txt(W_PX - 170, ly + 34, "HAT %s × 1970 × 830  ·  YEDEK DOLAP 14 hazne (2 gün) + TEKNİK  ·  TOPPING Atosa 1143 · 7 hazne (1 gün)  ·  STORE %d çekmece (3 gün)" % (sayi(HAT), CEK), f9, GRAY, "rm")

assert not os.path.exists(OUT), "3 gunluk v1 zaten var — yeni numara ver"
