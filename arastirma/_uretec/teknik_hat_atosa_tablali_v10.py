...
def tablali():
    ...
    baslik("AUTOKITCH  ·  ATOSA TABLALI HAT  ·  TEKNİK RESİM  v10  ·  MONTAJ = hat_montaj_v43  ·  TOPPING = topping_uno_cad_v4 (4 UNO + kaşar/sucuk kaseti · havalı) + topping_cad_v22 tabla · E = kutu_cad_v3 · B = store_cad_v4  ·  ALT TABAN 123 · SÜREÇ 1168  ·  HAT 5430 × 2030 × 830",
    ...
    dline((fx(2375.0), py(-790.0)), (fx(4300.0), py(-790.0)), (60, 110, 200), 3, 10, 6)
    ...
    parca_listesi([
        ...
        ("HAVA", "JUN-AIR OF302-15B yağsız kompresör · 15 L · 43 L/dk @ 7 bar · K taban dolabında · Ø10 ana hat F tabanı arkasından TOPPING'e", "1", "380 × 380 × 510 · 25 kg · AÇIK: yeri (kural: istasyon kendi gövdesinde)"),
        ...
        ("KONTROL", "ana pano PLC + UPS + robot kontrol kutusu: F taban dolabı · TOPPING'in kendi panosu + UPS + güç + soğutma grubu üst bantta, 4 sürücü kuru bölmede · ekran yok (tablet)", "", ""),
    ])
    lejant()
    yol = KLASOR + r"\HAT_ATOSA_TABLALI_v10_HD.png"
    im.save(yol, dpi=(int(200 * K_HD), int(200 * K_HD))); print("yazildi:", yol, "· hat", sayi(HAT), "· bilek", round(D1), round(D2))
    return yol
...
if __name__ == "__main__":
    ...
    k.save(KLASOR + r"\HAT_ATOSA_TABLALI_v10_EKRAN.png", optimize=True); print("yazildi EKRAN", k.size)
