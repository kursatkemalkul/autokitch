# -*- coding: utf-8 -*-
"""yolculuk_v47 → yolculuk_v48 (ANA MAKİNE, 26 Eyl gece): TP10 kesitli fırın (firin_tp10_cad_v3) ana hatta. yolculuk_tp10_v2 ile aynı mantık:
TOPPING'in aktarma bandı yok · ürün diskte 79 mm arkaya kayar (itici AÇIK) · fırında −249 düz · K bandındaki 20° giriş çiti −170'e alır ·
fırın + giriş bandı ruloları kendi ekseninde döner."""
import io, os
...
s = s.replace("# ---------------------------------------------------------------- v45 · 1 TAM ANİMASYON: ÜRÜN YOLCULUĞU",
              "# ---------------------------------------------------------------- v45 · 1 TAM ANİMASYON: ÜRÜN YOLCULUĞU (v48: yolculuk_v48)", 1)
io.open(os.path.join(U, "yolculuk_v48.py"), "w", encoding="utf-8").write(s)
print("yolculuk_v48.py yazildi")
