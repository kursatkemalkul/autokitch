...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_BASE_v9_3gun_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 4400, 2800
S = 0.62
...
YUZ0 = CELL0 - BIND
HH = {"hamur": 75.0, "lahm": 60.0, "icecek": 132.0, "raf": 267.0}
AD = {"hamur": "TAZE PİDE", "lahm": "LAHMACUN", "icecek": "İÇECEK 330 ml", "raf": "YEDEK KASET RAFI"}
CAP = {"hamur": (20, "top"), "lahm": (35, "top"), "icecek": (56, "kutu"), "raf": (4, "kaset")}
KOLON = [[(12, "hamur", "+3"), (2, "lahm", "+3")],
         [(16, "lahm", "+3")],
         [(4, "icecek", "+3"), (1, "raf", "+3")]]
...
ISTASYON = [("STORE v7", WS, DZ), ("PRESS v6", 700.0, DZ), ("TOPPING v6", 700.0, DZ),
...
YUVA = {"kat1": ("KAŞAR", "SUCUK"), "kat2": ("HARÇ", "HARÇ"), "kat3": ("KIYMA", "KUŞBAŞI"),
        "alt1": ("HARÇ", "HARÇ", "KIYMA", "KUŞBAŞI"), "alt2": ("SUCUK", "KAŞAR", "HARÇ", "HARÇ")}
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  BASE HAT  ·  TEKNİK RESİM  v9  ·  TAM 3 GÜN", f38, INK)
txt(OX, 138, "ön · üst · yan görünüş  ·  günde 80 pide + 200 lahmacun  ·  tam 3 gün stok  ·  tüm istasyonlar 830 derin  ·  ölçüler mm  ·  14 Eylül 2026", f13, GRAY)
...
txt(W_PX - 170, ly, "HAT %s × 1970 × 830  ·  tam 3 gün  ·  STORE %d çekmece (12 pide · 18 lahmacun · 4 içecek)  ·  kaset 18: TOPPING 14 yuva + STORE rafı 4  ·  OVEN 3 hazne" % (sayi(HAT), cek), f9, GRAY, "rm")

assert not os.path.exists(OUT), "v9 zaten var — yeni numara ver"
