...
kam = rep.create.camera(position=(1.5, 1.1, 2.2), look_at=(0.9, 0.25, -0.2), focal_length=22.0)
urun = rep.create.render_product(kam, (1600, 900))
...
def kamera_takip():
    x = araba_x() / 1000.0
    with kam:
        rep.modify.pose(position=(x + 0.6, 1.1, 2.2), look_at=(x, 0.25, -0.2))
