...
ICERIK
  · TOPPING_fizik_v8.usd        makinenin kendisi (534 parca, 14 eklem, gercek kutleler)
...
MAKINE = os.path.join(FIZ, "TOPPING_fizik_v8.usd")
CIKTI = os.path.join(FIZ, "TOPPING_IKIZ_v8.usd")
...
rk.AddTranslateOp().Set(Gf.Vec3d(ISTASYON, -0.70, 0.0))    # Z-yukari: robot yerde (z=0), makinenin 700 mm onunde (-y)
rk.AddRotateZOp().Set(90.0)                                # makineye donuk (Z-yukari sahnede Z etrafinda)
