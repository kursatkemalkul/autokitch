...
tx(X0,Y0-70,"AUTOKITCH — HAT v30 · HAFTALIK TAM DÖNGÜ (3 kapı) + SERVİS İSTASYONU 70",15,"start","bold")
...
tx(X0,Y0-50,"ölçüler cm · HER ŞEY HAFTALIK — TEK LOJİSTİK GÜNÜ: fırıncı 560 şoklanmış top (K1 240 + K2 220 + tampon 100) · et/peynir porsiyon · içecek/tatlı · karton — hepsi aynı sabah",10.5,"start")

W=int(X0+px(T)+px(1030)); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v30.svg"
