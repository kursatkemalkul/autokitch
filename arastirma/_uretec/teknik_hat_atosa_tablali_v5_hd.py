...
def tablali():
    ...
    baslik("AUTOKITCH  ·  ATOSA TABLALI HAT  ·  TEKNİK RESİM  v5 · HD  ·  TOPPING = topping_cad_v21  ·  TABLA ARABASI AÇICI → DOZAJ → FIRIN  ·  HAT 5300 × 2030 × 830",
    ...
    lejant()
    yol = KLASOR + r"\HAT_ATOSA_TABLALI_v5_HD.png"
    im.save(yol, dpi=(int(200 * K_HD), int(200 * K_HD))); print("yazildi:", yol, "· hat", sayi(HAT), "· bilek", round(D1), round(D2))
