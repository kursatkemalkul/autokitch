...
def tablali():
    ...
    baslik("AUTOKITCH  ·  ATOSA TABLALI HAT  ·  TEKNİK RESİM  v4  ·  TOPPING = topping_cad_v21  ·  TABLA ARABASI AÇICI → DOZAJ → FIRIN  ·  HAT 5300 × 2030 × 830",
    ...
    lejant()
    yol = KLASOR + r"\HAT_ATOSA_TABLALI_v4_teknik.png"
    im.save(yol, dpi=(200, 200)); print("yazildi:", yol, "· hat", sayi(HAT), "· bilek", round(D1), round(D2))
