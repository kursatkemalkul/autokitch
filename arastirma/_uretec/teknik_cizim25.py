...
not_((a0+a1)/2,Y0+px(24),"soğutma grupları ×2 — standart ÜST bölme (kuru sarf → servis istasyonuna taşındı)")
not_((a0+am)/2,Y0+px(345),"DONMUŞ −18° · 4 raf × 20 = 80 — 1 GÜNLÜK")
rc(a0+px(50),Y0+px(1150),px(450),px(48),1,2)
rc(a0+px(50),Y0+px(1205),px(450),px(48),1,2)
for i in range(3): rc(a0+px(60)+i*px(150),Y0+px(1290),px(130),px(120),1,2)
for r in range(2):
    for i in range(3): rc(a0+px(60)+i*px(150),Y0+px(1440)+r*px(140),px(130),px(128),1,2)
rc(a0+px(60),Y0+px(1720),px(150),px(110),1,2); rc(a0+px(240),Y0+px(1720),px(150),px(110),1,2)
not_((a0+am)/2,Y0+px(1132),"AMBİENT (izolesiz): kutu destesi ×2 ≈100")
not_((a0+am)/2,Y0+px(1268),"saçet · peçete kolileri")
not_((a0+am)/2,Y0+px(1428),"haftalık içecek kolileri ≈9 (≈200)")
not_((a0+am)/2,Y0+px(1706),"yedek sadeyağ tenekeleri")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v25 · MAKİNE 415 + SERVİS İSTASYONU 70 · dolap standart üst-motorlu",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · dolap üstü TEMİZ: motorlar standart üst bölmede · sol alt AMBİENT bölme: desteler+saçet/peçete+haftalık içecek+teneke · kutu: makine 70 + servis 320 + ambient 100 ≈ 6 gün",10.5,"start")

W=int(X0+px(T)+px(1030)); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v25.svg"
