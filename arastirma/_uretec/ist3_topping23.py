...
tx(30,42,'AUTOKITCH — İSTASYON 3 · TOPPING v23 (5 Eyl 2026) — TEK KAP TİPİ 16×54×24 (simetrik, ağız ortada) · 3 kat × 2 = 6 pozisyon · üst teknik yok: elektrik arka duvarda, soğutma ALT arkasında · ALT 8 beşik · 70×197×84',15,'start','bold')
...
ipoly([(2,58,0),(68,58,0),(68,58,50),(2,58,50)],1,'#555','#cfd8dc',None,.95)
ipoly([(2,58,50),(68,58,50),(68,74,50),(2,74,50)],1,'#555','#b0bec5',None,.95)
ipoly([(68,58,0),(68,74,0),(68,74,50),(68,58,50)],1,'#555','#c0cbd1',None,.95)
...
ipoly([(0,0,52),(70,0,52),(70,58,52),(0,58,52)],.9,'#7fb3d5',ICE,None,.6)
ipoly([(0,0,72),(70,0,72),(70,58,72),(0,58,72)],.9,'#7fb3d5',ICE,None,.5)
t=P(35,20,62); tx(t[0],t[1],'evaporatör + fan · soğuk hava arka duvar kanalından katlara',5.6,'middle','',BLU)
ipoly([(0,0,0),(70,0,0),(70,0,8),(0,0,8)],1,'#555','#9e9e9e',None,.8); t=P(35,0,4); tx(t[0],t[1]+3,'plint ızgarası (hava)',5,'middle','','#fff')
for row,zf in ((0,9),(1,30)):
    for i in range(4):
        x0=1.2+i*17.2
...
t=P(0,-2,42); tx(t[0]-6,t[1]+8,'ALT 74: 2 sıra × 4 beşik (U yatak, tek tip) + arkada soğutma',6.5,'end','bold',GRY)
...
rc(XC,YC+K*(197-74),K*70,K*22,.7,0,'#7fb3d5',None,ICE); tx(XC+K*35,YC+K*(197-63),'evaporatör + fan',4.8,'middle','',BLU)
...
tx(W-40,H-12,'AUTOKITCH · arastirma/3_TOPPING/ist3_topping_detay_v23 · 5 Eyl 2026',7,'end','',GRY)
o.append('</svg>')
svg = chr(10).join(o)
xml.dom.minidom.parseString(svg.encode('utf-8'))
out = r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\3_TOPPING\ist3_topping_detay_v23.svg"
