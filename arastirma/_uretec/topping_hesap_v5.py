...
# ---------------------------------------------------------------- 4 · ELEKTRİK ----------------------------------------------------------------
# v5: 2,0 A VARSAYIMDI. Gerçek motor STP-MTR-23079, üreticinin kendi tablosunda
# (surestepmotors.pdf s.3) faz akımı 2,8 A. Güç kaynağı da onunla birlikte büyüyor:
# 24 × 2,8 × 2 × 1,6 = 215 W (eskiden 154 W).
MOTOR_A = 2.8                                            # NEMA23 faz akımı [surestepmotors.pdf s.3]
