...
ln(a0+px(30),Y0+px(1360),am-px(60),Y0+px(1360),1)
ln(a0+px(30),Y0+px(1600),am-px(60),Y0+px(1600),1)
for i in range(3): rc(a0+px(60)+i*px(190),Y0+px(1160),px(160),px(170),1,3)
for i in range(3): rc(a0+px(60)+i*px(190),Y0+px(1400),px(160),px(170),1,3)
for i in range(2): rc(a0+px(90)+i*px(240),Y0+px(1640),px(200),px(170),1,3)
for kz in range(8):
...
not_((a0+a1)/2,Y0+px(58),"TEK PARÇA 2 kapılı kombine (standart) · soğutma ×2: sol −18° · sağ +3°")
not_((a0+am)/2,Y0+px(345),"DONMUŞ −18° · 4 raf × 20 = 80 — 1 GÜNLÜK")
not_((a0+am)/2,Y0+px(1148),"KURU SARF (izolesiz) — saçet · peçete · yedek teneke · karton")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v19 · SOĞUK DEPO 2 KAPI · 415 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · ORANLAR: ılık 4 · TAZE 160 = 2 GÜN · DONMUŞ 80 = 1 GÜN · içecek 122 (su 0,33 kutu) · tatlı 20 · sol alt: kuru sarf · ayak 12",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v19.svg"
