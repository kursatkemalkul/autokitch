...
ÇIKTI: arastirma/3_TOPPING/topping_modul_v7/ (parça başına STEP + STL, MONTAJ.step, BOM.csv) · otonom/hat3d/ (GLB/USDZ)
...
URETIM = os.path.join(KOK, "arastirma", "3_TOPPING", "topping_modul_v7")
...
KASET_CAD = {"HARÇ 1": "harc_cad_v2", "HARÇ 2": "harc_cad_v2", "KIYMA": "kiyma_cad_v7",
...
if __name__ == "__main__":
    ...
    print("TOPPING MODULU v7 · %d parca (%d cizili + %d yalniz listede) · %.0f sn" % (len(PARCALAR), len(gercek), len(PARCALAR) - len(gercek), time.time() - t0))
