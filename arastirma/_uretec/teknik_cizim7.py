...
a0,a1=xs[0],xs[1]
rc(a0+8,Y0+px(40),a1-a0-16,px(300),1.6)                           # ilik vitrin
ln(a0+15,Y0+px(185),a1-15,Y0+px(185),1)
for i in range(5): ci(a0+26+i*px(107),Y0+px(135),px(50))
for i in range(5): ci(a0+26+i*px(107),Y0+px(290),px(50))
rc(a0+8,Y0+px(370),a1-a0-16,px(840),1.6)                          # buzdolabi 6 raf
for r in range(6):
    yv=Y0+px(370)+px(130)+r*px(130)
    if r<5: ln(a0+15,yv,a1-15,yv,1)
    for i in range(5): ci(a0+26+i*px(107),yv-px(50),px(50),1)
rc(a0+8,Y0+px(1240),a1-a0-16,px(590),1.6)                         # rezerv 4 raf (ayni aralik)
for r in range(4):
    yv=Y0+px(1240)+px(140)+r*px(140)
    if r<3: ln(a0+15,yv,a1-15,yv,1)
    for i in range(5): ci(a0+26+i*px(107),yv-px(50),px(50),1)
not_((a0+a1)/2,Y0+px(358),"ılık raf · 2×5 top Ø10")
not_((a0+a1)/2,Y0+px(398),"GN 2/1 · 6 raf ≈180")
not_((a0+a1)/2,Y0+px(1262),"rezerv · 4 raf ≈120 (plan ≈60)")
tx(a0+14,Y0+px(58),"30",9.5,"start","", "#555"); tx(a0+14,Y0+px(388),"84",9.5,"start","", "#555"); tx(a0+14,Y0+px(1310),"59",9.5,"start","", "#555")
...
tx(b0+40+px(200),Y0+px(1600),"çöp 50 L (önde)",9.5,"middle","","#555")
tx(b0+40+px(200),Y0+px(1700),"arkada: hamur dolabı soğutma grubu ×2",9,"middle","","#555")
...
yv=Y0+px(1045); ln(f0+16,yv,f1-16,yv,1)
for i in range(5): rc(f0+16+i*px(87),yv-px(312),px(90),px(310),1)
rc(f0+10,Y0+px(1120),f1-f0-20,px(710),1.6)
for r in range(3):
...
not_((f0+f1)/2,Y0+px(1108),"paketli tatlı / saçet")
...
rc(a0+px(35),YT2+px(95),px(530),px(650),1.4)
for j in range(6):
    for i in range(5): ci(a0+26+i*px(107),YT2+px(150)+j*px(108),px(50),1)
not_((a0+a1)/2,YT2+px(60),"GN tepsi 53×65 — 5×6 = 30 top")

# PRES: PZP govde 64x80, taban Ø28
rc(bm-px(320),YT2+px(20),px(640),px(800),1.6)
ci(bm,YT2+px(420),px(140),1.4)
rd(bm-px(290),YT2+px(500),px(580),px(280))
ci(bm-px(140),YT2+px(640),px(70),1); ln(bm-px(190),YT2+px(590),bm-px(90),YT2+px(690),.9); ln(bm-px(190),YT2+px(690),bm-px(90),YT2+px(590),.9)
ci(bm+px(140),YT2+px(640),px(70),1); ln(bm+px(90),YT2+px(590),bm+px(190),YT2+px(690),.9); ln(bm+px(90),YT2+px(690),bm+px(190),YT2+px(590),.9)
not_(bm,YT2+px(890),"PZP-400 64×80 · kesik: altta soğutma grupları ×2 (dolap + rezerv)")
...
for i in range(7): ln(f0+16+i*px(70),YT2+px(60),f0+16+i*px(70),YT2+px(660),1)
for i in range(6):
    for j in range(3): ci(f0+16+px(35)+i*px(70),YT2+px(150)+j*px(250),px(30),.9)
rd(f0+16,YT2+px(690),f1-f0-32,px(110))
ci((f0+f1)/2,YT2+px(745),px(45),.9)
not_((f0+f1)/2,YT2+px(890),"kanal ×6 · arka şerit: içecek soğutma grubu")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v7 · ÖN + ÜST GÖRÜNÜŞ · 385 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · derinlik 84 · gövde 185 + ayak 12 (robot süpürge kleransı) · buzluk raf aralığı = dolapla aynı (14) · pres CP-330 seçilirse 375",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v7.svg"
