# -*- coding: utf-8 -*-
"""TOPPING v2 (UNO'lu) · 3B MODEL · topping_uno_cad_v4 · 25 Eyl 2026
...
def glb_yaz(yol):
    ...
    while off[0] % 4: blob.append(b"\x00"); off[0] += 1
    bb_ = b"".join(blob)
    gl = {"asset": {"version": "2.0", "generator": "AUTOKITCH topping_uno_cad_v4"}, "scene": 0, "scenes": [{"nodes": [0]}], "nodes": nodes, "meshes": meshes,
...
if __name__ == "__main__":
    ...
    assert not kal, kal
    glb_yaz(os.path.join(OUT, "topping_uno_v4.glb"))
