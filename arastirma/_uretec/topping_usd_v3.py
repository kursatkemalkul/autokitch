# -*- coding: utf-8 -*-
"""TOPPING MODULU -> ISAAC SIM FIZIKLI USD (2. asama) — v3
...
CIKTI = os.path.join(GIR, "TOPPING_fizik_v3.usd")
...
def main():
    ...
    def eklem_kur(e):
        ...
        if e["tip"] == "prizmatik":
            ...
            tip_s = "angular"
            hedef_hiz = 0.0
            # GERCEK SINIR: tabla = NEMA23 pancake i=1 -> 0,9 N·m · kaset milleri = NEMA23 + planet i=10 -> 12 N·m
            maxkuv = 0.9 if e["ad"] == "TABLA" else 12.0
