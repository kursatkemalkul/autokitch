...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_2KOL_v9_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 6200, 3400
S = 0.62
...
CAP = {"hamur": (20, "top"), "lahm": (35, "top"), "depo": (0, "17,6 kg kaşar + 5,6 kg sucuk · 4 gün (+ 2 gün haznede)")}
    ...
    for adet, tip in gruplar:
        ...
        for _ in range(adet):
            ...
            if tip == "depo":
                ...
                txt(fx(cx + WO / 2 - 15), fy(y + h - 45.0), "üst raf: kaşar 17,6 kg (vakum paketler) · alt raf: sucuk 28 çubuk", f7, GRAY, "mm")
            y += h + FUGA
        cap, br = CAP[tip]
...
txt(fx(X_A + W_B / 2), fy(0) + 190, "MODÜL B · ÇEKMECE MODÜLÜ · 8 pide + 12 lahmacun + kaşar/sucuk 4 günlük kapaklı bölme · 3 kolon · soğutucusu K1 altında · A ve C üstüne oturur", f8, BG, "mm")
...
PARCA = [
    ...
    ("DEPO", "kapaklı soğuk bölme 620 × 680 × 240 · 2 raf · elle açılır", "1", "kaşar 17,6 kg + sucuk 5,6 kg · 4 gün · K3 üstü"),
