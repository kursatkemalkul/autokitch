# -*- coding: utf-8 -*-
"""AUTOKITCH - TOPPING DOZAJ KATI · USTTEN GORUNUS · TEPSI HAREKETI v1 (13 Eyl 2026). Olculer mm.
...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\3_TOPPING_v4\TOPPING_dozaj_hareketi_v1.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 2200, 1780
...
# ======================= BASLIK =======================
txt(100, 50, "AUTOKITCH  ·  TOPPING DOZAJ KATI  ·  ÜSTTEN GÖRÜNÜŞ  ·  TEPSİ HAREKETİ  v1", f38, INK)
txt(100, 120, "700 mm kabin  ·  2 kaset yan yana  ·  tepsi Ø320  ·  pide Ø300  ·  ölçüler mm  ·  13 Eylül 2026", f13, GRAY)
