...
d = sw.OpenDoc6(os.path.join(R,"PICKUP_v1.SLDASM"), 2, 0, "", e, w); mcall(d,"EditRebuild3")
...
d.ClearSelection2(True)
png(d, os.path.join(R,"PICKUP_v1_iso.png"), "*Isometric")
png(d, os.path.join(R,"PICKUP_v1_on.png"), "*Front")
n=0
def gez(c):
    global n
...
print("PICKUP v1 acik | bilesen: %d | hata=%d uyari=%d" % (n, e.value, w.value))
sw.Visible = True
