...
ln(a2+15,Y0+px(445),a3-15,Y0+px(445),1)
for i in range(4): ci(a2+px(130)+i*px(125),Y0+px(378),px(50))
ln(a2+px(35),Y0+px(455),a3-15,Y0+px(455),1.4)
ln(a2+px(35),Y0+px(1512),a3-15,Y0+px(1512),1.4)
rc(a2+px(40),Y0+px(500),a3-px(60)-a2-px(40),px(965),1)
for kz in range(13):
    ln(a2+px(60),Y0+px(545)+kz*px(70),a2+px(85),Y0+px(545)+kz*px(70),.8)
    ln(a3-px(85),Y0+px(545)+kz*px(70),a3-px(60),Y0+px(545)+kz*px(70),.8)
for r in range(8):
    ty=Y0+px(590)+r*px(124)
...
not_((a2+a3)/2,Y0+px(340),"ılık AÇIK raf · 4 (ısıtmalı pres tamponu)")
not_((a2+a3)/2,Y0+px(482),"TAZE +3 °C · 8 raf × 20 = 160 — 2 GÜNLÜK · çukur hendeği 1 cm")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v21 · SOĞUK DEPO 2 KAPI · 415 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · KURU BANT TAM 140 ÜSTTE · motorlar SOL ALTTA (standart alt-grup) · boy DEĞİŞMEDİ · ılık 4 · TAZE 160=2G · DONMUŞ 80=1G · içecek 122 · tatlı 20 · ayak 12",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v21.svg"
