...
ÇIKTI: arastirma/3_TOPPING/topping_modul_v5/ (parça başına STEP + STL, MONTAJ.step, BOM.csv) · otonom/hat3d/ (GLB/USDZ)
...
URETIM = os.path.join(KOK, "arastirma", "3_TOPPING", "topping_modul_v5")
...
if __name__ == "__main__":
    ...
    print("TOPPING MODULU v5 · %d parca (%d cizili + %d yalniz listede) · %.0f sn" % (len(PARCALAR), len(gercek), len(PARCALAR) - len(gercek), time.time() - t0))
