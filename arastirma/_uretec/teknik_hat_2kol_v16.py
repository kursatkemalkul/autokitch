...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_2KOL_v16_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 6600, 3400
S = 0.62
...
YAG = (345.0, 590.0)
KES = (595.0, 860.0)
FIR = [(865.0, 1180.0, "FIRIN HAZNESİ 1|LAHMACUN · 120 s"), (1185.0, 1500.0, "FIRIN HAZNESİ 2|LAHMACUN · 120 s"),
       (1505.0, 1828.0, "FIRIN HAZNESİ 3|PİDE · PİZZA · 240 s · ayrı sıcaklık")]
# E · KUTU kolonu
E_MEK = (123.0, 420.0)
E_AGZ = (430.0, 680.0)
E_SAR = (690.0, 2028.5)
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  HAT 2 KOL  ·  TEKNİK RESİM  v16  ·  TEPSİ SOKETLİ (ÇATAL YOK)  ·  TOPPING 1800  ·  İÇECEK + TATLI K3 ÜSTÜNDE  ·  DEPO K4'TE  ·  HAT 3900 × 2030", f38, INK)
...
kesik(X_D, 60.0, 640.0, 140.0, 325.0, "ROBOT KONTROL KUTUSU · ray yanında", INK, "245 × 180 × 45 · kablo → zemin → ray zinciri → robot (~3 m)")
kapak(X_D, 33.0, 667.0, 1833.0, 2028.0, "BOŞ|634 × 770 × 195")
...
txt(sz2(-705.0), fy(1340.0), "EGZOZ", f7, GRAY, "mm")
txt(sz2(40) + 14, fy(1340.0), "MOTORLU KAPAK", f8, RED, "lm")
...
PARCA = [
    ...
    ("FIRIN", "yıldız kesici Ø300 + piston · yağ kartuşu 4 L × 2 + sprey", "1", "kesim 595–860 · yağ 345–590"),
