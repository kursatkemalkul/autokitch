...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_2KOL_v7_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 6200, 3400
S = 0.62
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  HAT 2 KOL  ·  TEKNİK RESİM  v7  ·  5 KAPALI İSTASYON  ·  HER İSTASYONUN YAN KESİTİ  ·  CONTALI MOTORLU ÇEKMECE  ·  HAT 3500 × 2030", f38, INK)
txt(OX, 138, "ön · üst · yan görünüş  ·  günde 80 pide + 200 lahmacun (+ pizza)  ·  2 gün stok  ·  her istasyon kendi soğutucusu / motoru / panosuyla kapalı ürün  ·  21 contalı motorlu çekmece tek modülde  ·  hat yüksekliği 2030 (B 1060 + pres 950 + pay)  ·  harç 2 kaset (kaşar kalıbı 280)  ·  2 × Fairino FR10 koridorda  ·  QR dolabı yok  ·  tüm modüller 830 derin  ·  ölçüler mm  ·  17 Eylül 2026", f13, GRAY)
...
for ki in range(3):
    ...
    if ki:
        txt(fx(cx + 66), py(-560.0), "LİNEER MOTOR 24 V · 700 strok", f7, RED, "lm")
...
PARCA = [
    ("MODÜL B", "ÇEKMECE modülü · 21 çekmece · soğutma grubu K1 altında · A ve C altında", "1", "2100 × 830 × 1060 · K1 6 pide · K2 2 pide + 6 lahm · K3 6 lahm + içecek"),
    ...
    ("ÇEKMECE", "contalı çekmece 620 × 680 · önü 40 PU · 24 V lineer motor 700 strok", "21", "8 pide · 12 lahm · 1 içecek 2 katlı (180 kutu + tatlı 14)"),
...
txt(W_PX - 170, ly, "HAT %s × 2030 × 830  ·  5 kapalı istasyon (B altta, A + C üstünde)  ·  2 gün  ·  21 çekmece (8 pide · 12 lahmacun · 1 içecek 2 katlı)  ·  Atosa dozaj tablasız: 2 harç 280 + kıyma + kuşbaşı + kaşar 280 + sucuk dilimleyici  ·  FIRIN 3 göz  ·  2 × FR10  ·  QR dolabı yok" % sayi(HAT), f9, GRAY, "rm")
