...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_2KOL_v14_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 6600, 3400
S = 0.62
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  HAT 2 KOL  ·  TEKNİK RESİM  v14  ·  TEPSİ SOKETLİ (ÇATAL YOK)  ·  TOPPING 1800  ·  İÇECEK + TATLI K3 ÜSTÜNDE  ·  DEPO K4'TE  ·  HAT 3900 × 2030", f38, INK)
...
kesik(X_BC, 1520.0, 1765.0, T_SOG[0] + 40.0, T_SOG[0] + 85.0, "ROBOT KONTROL KUTUSU", INK)
txt(fx(X_BC + 1642.0), fy(T_SOG[0] + 97.0), "245 × 180 × 45", f7, GRAY, "mm")
kesik(X_BC, 1520.0, 1765.0, T_SOG[0] + 115.0, T_SOG[0] + 290.0, "UPS", GRAY, "500 VA")
...
kesik(X_D, 50.0, 330.0, 150.0, 330.0, "FIRIN PANOSU", INK, "D'nin kendi kartı")
satirlar(fx(X_D + 350), fy(430.0), "BOŞ BÖLME|634 × 770 × 417 · yedek parça / servis", f8, GRAY)
...
txt(fx(X_D + 350), py(-700.0), "EGZOZ KANALI · fan · karbon filtre · altı boş bölme", f7, GRAY, "mm")
# E plan
...
drect(sz2(-700.0), fy(330.0), sz2(-450.0), fy(150.0), INK, 1)
txt(sz2(-575.0), fy(240.0), "FIRIN PANOSU", f7, INK, "mm")
txt(sz2(-250.0), fy(330.0), "boş bölme", f7, GRAY, "mm")
txt(sz2(-364.0), fy(515.0), "D altı · fırın panosu + boş", f7, GRAY, "mm")
...
PARCA = [
    ...
    ("KONTROL", "ana pano PLC · robot kontrol kutusu 245 × 180 × 45 · UPS · taşınır tablet (makinede ekran yok)", "1", "C üst bandının sağ boşluğu (x 1100–1765 · kot 1730–1980)"),
]
kol = (0, 130, 700, 800)
th = 30
