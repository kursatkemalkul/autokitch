...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_2KOL_v10_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 6600, 3400
S = 0.62
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  HAT 2 KOL  ·  TEKNİK RESİM  v10  ·  TEPSİ SOKETLİ (ÇATAL YOK)  ·  TOPPING 1800  ·  K4 TEKNİK + TEPSİ NİŞİ  ·  HAT 3900 × 2030", f38, INK)
...
agiz(X_A, 53.0, 647.0, PLAKA, PLAKA + 220.0, "PRES AĞZI · alt kenar plaka kotunda · tepsi sapıyla girer")
    ...
    for adet, tip in gruplar:
        ...
        for _ in range(adet):
            ...
            if tip == "depo":
                ...
                txt(fx(cx + WO / 2 - 15), fy(y + h - 45.0), "üst: kaşar 17,6 kg · alt: sucuk 28 çubuk", f7, GRAY, "mm")
            y += h + FUGA
        cap, br = CAP[tip]
...
kapak(X_A, K4X - X_A + 8.0, K4X - X_A + K4W - 8.0, 130.0, 470.0)
kesik(X_A, K4X - X_A + 20.0, K4X - X_A + K4W - 20.0, 140.0, 360.0, "SOĞUTMA GRUBU|400 × 300 × 220 · ⅓ HP", INK, "ön ızgara")
kesik(X_A, K4X - X_A + 20.0, K4X - X_A + 180.0, 375.0, 460.0, "B KARTI", INK)
kesik(X_A, K4X - X_A + 200.0, K4X - X_A + K4W - 20.0, 375.0, 460.0, "20 MOTOR|SÜRÜCÜSÜ", INK)
agiz(X_A, K4X - X_A + 8.0, K4X - X_A + K4W - 8.0, 500.0, 960.0, "")
satirlar(fx(K4X + K4W / 2), fy(935.0), "TEPSİ NİŞİ · 8 tepsi · raf 52|Ø340 + sap 150 · dişi soket · y 500–960", f7, RED, 14)
for i in range(8):
    yy = 512.0 + i * 50.0
...
txt(fx(X_A + W_B / 2), fy(0) + 190, "MODÜL B · ÇEKMECE MODÜLÜ · 8 pide + 12 lahmacun + kaşar/sucuk 4 günlük kapaklı bölme · 3 kolon + K4 teknik/tepsi kolonu · soğutucu K4 altında · A ve C üstüne oturur", f8, BG, "mm")
...
txt(fx(HAT / 2), py(RZ + 200) + 80, "R1: A + B + C (0–2500)  ·  R2: D + E (2500–3900)  ·  tepsi devri D önünde  ·  tepsiler K4 nişinde", f9, INK, "mm")
...
PARCA = [
    ("MODÜL B", "ÇEKMECE modülü · 20 çekmece + kapaklı depo + K4 teknik/tepsi kolonu", "1", "2500 × 830 × 1060 · K1 6 pide · K2 2 pide + 6 lahm · K3 6 lahm + depo · K4 soğutma + kart + 8 tepsi"),
    ...
    ("TEPSİ", "Ø340 · sap 150 · dişi soket · ayaklı", "8", "K4 nişi 500–960 · 6 dolaşımda + 2 yedek"),
