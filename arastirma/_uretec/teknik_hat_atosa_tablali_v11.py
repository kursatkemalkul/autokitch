...
def tablali():
    ...
    kabin(X_C, W_C, H_B, H_MAK, "C · TOPPING v2 · 4 UNO + 2 kaset · havalı (montaj v43)")
    ...
    parca_listesi([
        ...
        ("MODÜL C", "TOPPING v2 (topping_uno_cad_v4) · 4 UNO çekirdeği (Beldos valf + ürün silindiri Ø52/Ø70 + Ø32 hava silindiri · bizim hazne: sos 15 L V · harç 45 L · kıyma 8 L · kuşbaşı 8 L) · sos + harç spreader + havalı kesme valfi · kaşar kaseti 280 + küp sucuk kaseti 140 · 3 mm taşıyıcı raf · valf adası 12 × 5/2 + şartlandırıcı kuru bölmede", "1", "1800 × 830 × 970 · disk üstü 1168 · tavan sos+harç 1968 · UYARI: tekne sağa 85, kasnak 35 mm taşıyor"),
        ...
        ("MODÜL K", "KESME · plaka 560 × 450 (z −470…−20) + yıldız bıçak Ø300 6 dilim + tereyağı spreyi + itici · taban dolabı: önde içecek yedeği · arkada kompresör + yağ + K kartı · üst bölme boş", "1", "600 × 830 × 2030 · plaka üstü 1164 · E için şart: itici 36 mm içeri kaydırır"),
    ...
    lejant()
    yol = KLASOR + r"\HAT_ATOSA_TABLALI_v11_HD.png"
    im.save(yol, dpi=(int(200 * K_HD), int(200 * K_HD))); print("yazildi:", yol, "· hat", sayi(HAT), "· bilek", round(D1), round(D2))
    return yol
...
if __name__ == "__main__":
    ...
    k.save(KLASOR + r"\HAT_ATOSA_TABLALI_v11_EKRAN.png", optimize=True); print("yazildi EKRAN", k.size)
