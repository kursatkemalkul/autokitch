...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_2KOL_v12_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 6600, 3400
S = 0.62
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  HAT 2 KOL  ·  TEKNİK RESİM  v12  ·  TEPSİ SOKETLİ (ÇATAL YOK)  ·  TOPPING 1800  ·  İÇECEK + TATLI K3 ÜSTÜNDE  ·  DEPO K4'TE  ·  HAT 3900 × 2030", f38, INK)
...
kesik(X_D, 50.0, 450.0, 150.0, 500.0, "ANA PANO · PLC + HMI · ana şalter", INK, "tüm hattın beyni · 400 × 350 × 250")
kesik(X_D, 470.0, 650.0, 150.0, 330.0, "ROBOT KONTROL", INK, "kutusu 245×180×45")
txt(fx(X_D + 560), fy(345.0), "245 × 180 × 45 × 2", f7, GRAY, "mm")
kesik(X_D, 470.0, 650.0, 360.0, 500.0, "UPS", GRAY, "fırın panosu")
