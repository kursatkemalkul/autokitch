...
M=[("SOĞUK DEPO — HAFTALIK TAM DÖNGÜ",2100),("PRES",700),("DOZAJ",700),("FIRIN",650),("KESİM+KUTU",700)]
...
a0,a1=xs[0],xs[1]; am=a0+px(700); am2=a0+px(1400)
rc(a0+8,Y0+px(10),a1-a0-16,px(290),1.6)
ci(a0+px(500),Y0+px(150),px(78),1.2); ci(a0+px(1600),Y0+px(150),px(78),1.2)
ln(a0+px(462),Y0+px(112),a0+px(538),Y0+px(188),.9); ln(a0+px(462),Y0+px(188),a0+px(538),Y0+px(112),.9)
ln(a0+px(1562),Y0+px(112),a0+px(1638),Y0+px(188),.9); ln(a0+px(1562),Y0+px(188),a0+px(1638),Y0+px(112),.9)
...
not_((a0+am)/2,Y0+px(340),"DONMUŞ K1 −18° · 12 raf = 240 top")
rc(am2-px(35),Y0+px(310),px(70),px(1530),1.2)
rc(am+px(25),Y0+px(370),am2-px(35)-am-px(25),px(1440),1)
for kz in range(20):
    ln(am+px(25),Y0+px(420)+kz*px(70),am+px(50),Y0+px(420)+kz*px(70),.8)
    ln(am2-px(85),Y0+px(420)+kz*px(70),am2-px(60),Y0+px(420)+kz*px(70),.8)
for i in range(4): rc(am+px(60)+i*px(150),Y0+px(430),px(130),px(90),1.2,2)
for r in range(11):
    ty2=Y0+px(604)+r*px(110)
    ln(am+px(60),ty2,am2-px(72),ty2,1.2)
    rc((am+am2)/2-px(80),ty2+px(4),px(160),px(13),.9,2)
    for i in range(4):
        ci(am+px(120)+i*px(125),ty2-px(46),px(44),1)
        el(am+px(120)+i*px(125),ty2-px(2),px(54),px(8),.8)
not_((am+am2)/2,Y0+px(340),"DONMUŞ K2 −18° · 11 raf = 220 + küvet rafı")
not_((am+am2)/2,Y0+px(410),"et/peynir/kavurma porsiyon küvetleri")
...
ln(am,YT2,am,YT2+px(840),1.4); ln(am2,YT2,am2,YT2+px(840),1.4)
for (g0,g1) in ((a0,am),(am,am2),(am2,a1)):
...
not_((a0+a1)/2,YT2+px(45),"tek kasa 3 KAPI: K1+K2 donmuş · K3 tampon+içecek — kapı yayları")
...
ln(sv+8,Y0+px(645),sv+sw-8,Y0+px(645),1)                            # kutu raf cizgileri
ln(sv+8,Y0+px(960),sv+sw-8,Y0+px(960),1)
ln(sv+8,Y0+px(1275),sv+sw-8,Y0+px(1275),1.4)
for rrr in (335,655,970):
    for i in range(6): ln(sv+px(80)+i*px(95),Y0+px(rrr),sv+px(80)+i*px(95),Y0+px(rrr)+px(295),.8)
not_(sv+sw/2,Y0+px(322),"AMBALAJ: dikine kutu 3 raf × 160 = 480 (+makine 80 = 560 = HAFTALIK)")
rc(sv+px(60),Y0+px(1330),sw-px(120),px(300),1.4,4)                  # temizlik kilitli
ci(sv+px(120),Y0+px(1368),px(16),1.1)
for i in range(4): rc(sv+px(110)+i*px(130),Y0+px(1430),px(90),px(180),1,3)
not_(sv+sw/2,Y0+px(1318),"TEMİZLİK — kilitli · mop kapı içinde")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v31 · HAFTALIK TAM DÖNGÜ (3 kapı) + SERVİS İSTASYONU 70",15,"start","bold")
...
tx(X0,Y0-50,"ölçüler cm · HER ŞEY HAFTALIK: top 560 şok (K1+K2+tampon) · kavurma donmuş küvet K2 · kaşar+sucuk dozaj altı (+3, 2-3 hafta dayanır) · kutu 480+80=560 · sadeyağ AYLIK (fırın altı) — TEK lojistik sabahı",10.5,"start")

W=int(X0+px(T)+px(1030)); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v31.svg"
