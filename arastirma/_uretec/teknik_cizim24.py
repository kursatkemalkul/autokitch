...
ln(a0+12,Y0+px(155),a1-12,Y0+px(155),1)
for i in range(7): rc(a0+px(40)+i*px(190),Y0+px(35),px(160),px(105),1,2)
for i in range(9): rc(a0+px(35)+i*px(150),Y0+px(175),px(125),px(110),1,2)
rc(a0+8,Y0+px(310),a1-a0-16,px(1530),1.8)                         # TEK GOVDE
rc(am-px(35),Y0+px(310),px(70),px(1530),1.2)                      # izoleli ara bolme
rc(a0+px(60),Y0+px(370),am-px(35)-a0-px(60),px(690),1)            # donmus ic (4 raf)
ln(a0+8,Y0+px(1100),am-px(35),Y0+px(1100),1.6)                    # ambient bolme ayirici (izolasyon siniri)

for kz in range(8):
    ln(a0+px(60),Y0+px(420)+kz*px(70),a0+px(85),Y0+px(420)+kz*px(70),.8)
    ln(am-px(85),Y0+px(420)+kz*px(70),am-px(60),Y0+px(420)+kz*px(70),.8)
for r in range(4):                                                # 4 raf = 1 gunluk 80
...
not_((a0+a1)/2,Y0+px(24),"KURU SARF — ÜST BANT TAM 140 (insan bölgesi, robot gitmez): saçet · peçete · teneke · karton")
not_((a0+am)/2,Y0+px(345),"DONMUŞ −18° · 4 raf × 20 = 80 — 1 GÜNLÜK")
ln(a0+8,Y0+px(1350),am-px(35),Y0+px(1350),1.6)
ci(a0+px(180),Y0+px(1550),px(75),1.2); ci(a0+px(520),Y0+px(1550),px(75),1.2)
ln(a0+px(145),Y0+px(1515),a0+px(215),Y0+px(1585),.9); ln(a0+px(145),Y0+px(1585),a0+px(215),Y0+px(1515),.9)
ln(a0+px(485),Y0+px(1515),a0+px(555),Y0+px(1585),.9); ln(a0+px(485),Y0+px(1585),a0+px(555),Y0+px(1515),.9)
for g in range(4): ln(a0+20,Y0+px(1690)+g*px(15),am-20,Y0+px(1690)+g*px(15),.7)
not_((a0+am)/2,Y0+px(1388),"soğutma grupları ×2 — ALT bölme (standart alt-grup)")
rc(a0+px(50),Y0+px(1145),px(450),px(105),1,2)
rc(a0+px(50),Y0+px(1260),px(450),px(105),1,2)
for r in range(2):
    for i in range(3): rc(a0+px(80)+i*px(150),Y0+px(1395)+r*px(140),px(130),px(128),1,2)
not_((a0+am)/2,Y0+px(1128),"AMBİENT bölme (izolesiz): kutu destesi ×2 ≈100")
not_((a0+am)/2,Y0+px(1382),"haftalık içecek kolileri ≈9 (≈200 kutu)")

# A2 sag yari: ILIK + TAZE + iade
a2,a3=am,xs[1]
ln(a2+12,Y0+px(310),a3-15,Y0+px(310),1)
ln(a2+px(35),Y0+px(315),a3-15,Y0+px(315),1.4)
ln(a2+px(35),Y0+px(1512),a3-15,Y0+px(1512),1.4)
rc(a2+px(40),Y0+px(360),a3-px(60)-a2-px(40),px(1100),1)
for kz in range(15):
    ln(a2+px(60),Y0+px(405)+kz*px(70),a2+px(85),Y0+px(405)+kz*px(70),.8)
    ln(a3-px(85),Y0+px(405)+kz*px(70),a3-px(60),Y0+px(405)+kz*px(70),.8)
for r in range(8):
    ty=Y0+px(495)+r*px(138)
...
not_((a2+a3)/2,Y0+px(338),"TAZE +3 °C · 8 raf × 20 = 160 — 2 GÜN · ILIK RAF YOK: ısıtmalı pres, dolaptan direkt")
...
# ICECEK: 2 motorlu KUTU cekmecesi + 1L dik cekmece — hamurla ayni prensip (ustten alma)
for cy in (1520,1680):
    rc(a2+px(38),Y0+px(cy),px(420),px(150),1.6,3)                 # cekmece govdesi
    rc(a2+px(188),Y0+px(cy)+px(150),px(120),px(10),.9,2)          # 24V cekmece surucusu
    for i in range(5):
        rc(a2+px(50)+i*px(82),Y0+px(cy)+px(18),px(66),px(115),1)
for g in range(3): ln(a2+px(58)+4*px(82),Y0+px(1568)+g*px(28),a2+px(108)+4*px(82),Y0+px(1563)+g*px(28),.8)
tx(a2+px(50)+4*px(82)+px(33),Y0+px(1625),"T",11,"middle","bold")
rc(a2+px(468),Y0+px(1518),px(100),px(315),1.6,3)                  # 1L dik cekmece
rc(a2+px(476),Y0+px(1530),px(84),px(295),1)
not_((a2+a3)/2,Y0+px(1498),"İÇECEK: motorlu çekmece yalnız ÖN SIRA açığa çıkana dek açılır (~12 cm) — kol ÜSTTEN alır")
not_((a2+a3)/2,Y0+px(1845),"10 kanal × ~11 ≈ 105 — TÜMÜ kutu formatı (su 0,33 kutu) · T = TATLI kanalı ≈16 · sağda 1L dik çekmece ×8")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v24 · MAKİNE 415 (temiz otomatik) + SERVİS İSTASYONU 70 (ayrı duvar)",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · makinede depo işi YOK: haftalık kutu servis istasyonunda (320) + ambient bölmede (100) + makinede 70 ≈ 6 gün · haftalık içecek kolileri dolabın AMBİENT bölmesinde · fırın üstü karbon filtre entegre",10.5,"start")

W=int(X0+px(T)+px(1030)); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v24.svg"
