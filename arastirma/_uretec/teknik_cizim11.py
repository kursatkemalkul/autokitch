...
M=[("HAMUR",700),("PRES",700),("DOZAJ",700),("FIRIN",650),("KESİM+KUTU",700),("İÇECEK",600)]
...
for i in range(4): ci(a0+px(130)+i*px(125),Y0+px(395),px(50))
for i in range(4): ci(a0+px(130)+i*px(125),Y0+px(538),px(50))
...
for r in range(5):                                                # kenarli tepsiler (U) + toplar + surucu
    ...
    for i in range(4):
        ci(a0+px(130)+i*px(125),ty-px(52),px(50),1)
        el(a0+px(130)+i*px(125),ty-px(3),px(58),px(9),.8)
# REZERV 1440-1850
...
not_((a0+a1)/2,Y0+px(345),"ılık AÇIK raf · 2×4 top")
not_((a0+a1)/2,Y0+px(638),"çukurlu tepsi (Ø12) · pençe çukur boşluğuna dalar — 5 raf × 20 ≈ 100")
not_((a0+a1)/2,Y0+px(1487),"rezerv −18° · 2 raf ≈40")
...
for j in range(5):
    for i in range(4):
        ci(a0+px(150)+i*px(125),YT2+px(160)+j*px(125),px(50),1)
        ci(a0+px(150)+i*px(125),YT2+px(160)+j*px(125),px(60),.7)
...
not_((a0+a1)/2,YT2+px(45),"tepsi 4×5=20 çukur (iç halka top, dış çukur) · kapı+yay")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v11 · MODÜLER · 405 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · HER İSTASYON BAĞIMSIZ KABİN (kendi duvarı, sahada cıvatalanır) · 60 mm PU / sac duvarlar · kapılar çıkarılmış görünüş · ayak 12",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v11.svg"
