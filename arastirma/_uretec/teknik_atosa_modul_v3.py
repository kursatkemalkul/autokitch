# -*- coding: utf-8 -*-
"""PIDE & LAHMACUN MODULE - CONCEPT FRONT VIEW v3 (14 Sep 2026). v3: Kemal - varsayim yok, 80 pide + 200 lahmacun EN YUKSEK hedef (x1,4 kalkti), kilolar buna gore (kasar 20x130 + 20x90 = 4,4 kg/gun), her hazne hedef sure + en az 1 tam gun.
...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\ATOSA_MODUL_v3_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
...
# ---------------- BASLIK ----------------
txt(110, 28, "PIDE & LAHMACUN MODULE  ·  CONCEPT FRONT VIEW  v3", f44, INK)
