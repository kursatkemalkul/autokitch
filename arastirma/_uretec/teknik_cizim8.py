...
a0,a1=xs[0],xs[1]
rc(a0+8,Y0+px(10),a1-a0-16,px(350),1.6)                           # MOTOR bolmesi (standart ust grup)
ci(a0+px(150),Y0+px(185),px(90),1.2); ci(a0+px(430),Y0+px(185),px(90),1.2)
ln(a0+px(105),Y0+px(120),a0+px(195),Y0+px(250),.9); ln(a0+px(105),Y0+px(250),a0+px(195),Y0+px(120),.9)
ln(a0+px(385),Y0+px(120),a0+px(475),Y0+px(250),.9); ln(a0+px(385),Y0+px(250),a0+px(475),Y0+px(120),.9)
for g in range(4): ln(a0+20,Y0+px(300)+g*px(12),a1-20,Y0+px(300)+g*px(12),.7)
ln(a0+15,Y0+px(370),a1-15,Y0+px(370),1)                           # ILIK ACIK RAF (kapaksiz)
ln(a0+15,Y0+px(660),a1-15,Y0+px(660),1)
for i in range(5): ci(a0+26+i*px(107),Y0+px(455),px(50))
for i in range(5): ci(a0+26+i*px(107),Y0+px(608),px(50))
rc(a0+8,Y0+px(670),a1-a0-16,px(830),1.6)                          # buzdolabi 6 raf
for r in range(6):
    yv=Y0+px(670)+px(130)+r*px(130)
    if r<5: ln(a0+15,yv,a1-15,yv,1)
    for i in range(5): ci(a0+26+i*px(107),yv-px(50),px(50),1)
rc(a0+8,Y0+px(1510),a1-a0-16,px(330),1.6)                         # rezerv 2 raf
for r in range(2):
    yv=Y0+px(1510)+px(140)+r*px(140)
    if r<1: ln(a0+15,yv,a1-15,yv,1)
    for i in range(5): ci(a0+26+i*px(107),yv-px(50),px(50),1)
not_((a0+a1)/2,Y0+px(58),"soğutma grupları ×2 — standart üst motor bölmesi")
not_((a0+a1)/2,Y0+px(408),"ılık AÇIK raf (kapaksız) · 2×5 top")
not_((a0+a1)/2,Y0+px(698),"GN 2/1 · 6 raf ≈180")
not_((a0+a1)/2,Y0+px(1532),"rezerv · 2 raf ≈60 = plan")
tx(a0+14,Y0+px(80),"35",9.5,"start","", "#555"); tx(a0+14,Y0+px(440),"29",9.5,"start","", "#555"); tx(a0+14,Y0+px(688),"83",9.5,"start","", "#555"); tx(a0+14,Y0+px(1580),"33",9.5,"start","", "#555")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v8 · ÖN + ÜST GÖRÜNÜŞ · 385 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · STANDART mimari: dolap motoru üst bölmede · ılık raf açık (kapaksız) · içecek motoru altta · ayak 12 · pres CP-330 seçilirse 375",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v8.svg"
