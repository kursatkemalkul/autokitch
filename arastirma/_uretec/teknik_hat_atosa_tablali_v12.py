...
def tablali():
    ...
    baslik("AUTOKITCH  ·  ATOSA TABLALI HAT  ·  TEKNİK RESİM  v12  ·  MONTAJ = hat_montaj_v45  ·  TOPPING = topping_uno_cad_v5 (4 UNO + kaşar/sucuk kaseti · kama yarık) + topping_cad_v22 tabla · K = kesme_cad_v1 · E = kutu_cad_v3 · B = store_cad_v5 (tam kaplama)  ·  ALT TABAN 123 · SÜREÇ 1168  ·  HAT 5430 × 2030 × 830",
    ...
    lejant()
    yol = KLASOR + r"\HAT_ATOSA_TABLALI_v12_HD.png"
    im.save(yol, dpi=(int(200 * K_HD), int(200 * K_HD))); print("yazildi:", yol, "· hat", sayi(HAT), "· bilek", round(D1), round(D2))
    return yol
...
if __name__ == "__main__":
    ...
    k.save(KLASOR + r"\HAT_ATOSA_TABLALI_v12_EKRAN.png", optimize=True); print("yazildi EKRAN", k.size)
