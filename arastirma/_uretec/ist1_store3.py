...
tx(40,44,'İSTASYON 1 — STORE · DETAY v3 (v2 + ön görünüşte içerikler kesik çizgiyle · içecek çekmecesi 13 (dik kutu 12,3) · 1 L çekmecesi 32)',17,'start','bold')
...
for xx_,nm in ((xl2,'KAVURMA'),(xr2,'KUŞBAŞI')):
    ...
    tx(xx_+wcol2/2,Y0+px(1460),'KASET: %s ×2 · 17×21×25 · −18' % nm,6.5,'middle','bold',Bl)
...
for w_,lab,fl in parts:
    ...
    cx += p3(w_)
oy(x, cx, y+52, 'modül 683 → 2 modül + paneller = 1400 ✓', 8)
...
tx(W-24,H-14,'AUTOKITCH · ist1_store_detay_v3',10,'end','','#999')
...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\1_STORE\ist1_store_detay_v3.svg"
