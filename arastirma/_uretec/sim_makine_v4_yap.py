...
s = s.replace("import topping_cad_v10 as TC", "import topping_cad_v20 as TC")
...
yeni = """                   # v4 · TEPSISIZ KURGU: strok iki ucta da uzadi.
                   ...
                   strok=[-350.0, 1627.0], istasyon_x=-350.0, acici_x=-350.0, aktarma_x=1627.0,
...
yeni = ("""        # v4 · TEPSI YOK. Hamur dogrudan CALISMA DISKININ ustunde (disk ust yuzu y 108).
        ...
        aktarma=dict(x=1627.0, kopru_x=1700.0, kopru_y=108.3, bant_hiz=120.0),""" % round(RTOP, 1))
assert eski in s
s = s.replace(eski, yeni, 1)
