...
not_((a0+am)/2,Y0+px(348),"DONMUŞ −18° · 4 raf = 80 (1 GÜN)")
...
not_((a0+am)/2,Y0+px(1012),"HAFTALIK İÇECEK — 25 kanal × 11 = 275")
not_((a0+am)/2,Y0+px(1732),"tatlı çekmecesi 48 — haftalık 45")
...
not_((a2+a3)/2,Y0+px(1474),"1L çekmecesi 3×8=24 — haftalık 25")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v27 · TEK DOLAPTA HER ŞEY (2 kapı) + SERVİS İSTASYONU 70",15,"start","bold")
...
tx(X0,Y0-50,"ölçüler cm · 2 KAPILI kombi (tek kapı fiziken olmaz): SOL donmuş 80 üst + HAFTALIK içecek altta · SAĞ taze 160 + 1L · bayi haftada 1 çekmeceleri doldurur",10.5,"start")

W=int(X0+px(T)+px(1030)); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v27.svg"
