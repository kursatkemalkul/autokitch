# -*- coding: utf-8 -*-
# HAT: STORE v1 -> STORE_v2 (contali) degisimi
import os, time, pythoncom
from sw_lib import *
ARA = r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma"
HAT = os.path.join(ARA, "FULL_MAKINE", "HAT.SLDASM")
V2 = os.path.join(ARA, "1_STORE_v2", "STORE_v2.SLDASM")
...
print("STORE_v2 eklendi:", ok is not None)
d.ClearSelection2(True)
for cp in d.ConfigurationManager.ActiveConfiguration.GetRootComponent3(True).GetChildren:
    if cp.Name2.startswith("STORE_v2"): cp.Select4(True, NUL, False)
...
png(d, os.path.join(ARA, "FULL_MAKINE", "HAT_v2_iso.png"), "*Isometric", 2000, 1150)
