...
d = sw.OpenDoc6(os.path.join(R,"STORE_v3.SLDASM"), 2, 0, "", e, w); mcall(d,"EditRebuild3")
...
d.ClearSelection2(True)
png(d, os.path.join(R,"STORE_v3_iso.png"), "*Isometric")
png(d, os.path.join(R,"STORE_v3_on.png"), "*Front")
n=0
def gez(c):
    global n
...
print("STORE v3 acik | bilesen: %d | hata=%d uyari=%d" % (n, e.value, w.value))
sw.Visible = True
