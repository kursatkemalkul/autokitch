...
tx(X0,Y0-96,'İSTASYON 2 — PRESS · DETAY ÇİZİMİ v4',17,'start','bold')
...
tx(X0,Y0-54,'İsimler (ONAYLI, İNG): 1 STORE · 2 PRESS · 3 TOPPING · 4 OVEN · 5 PACK · 6 PICKUP (+SERVICE)',11,'start','','#555')
...
not_(X0+px(510),Y0+px(660),'günde ~1,5 L — bol yer')
not_(X0+px(510),Y0+px(710),'kova bel hizasında —')
not_(X0+px(510),Y0+px(750),'öne çekilir, MOTORSUZ')
not_(X0+px(510),Y0+px(800),'boşaltma: eleman HER GÜN')
...
tx(W-24,H-14,'AUTOKITCH · ist2_pres_detay_v4',10,'end','','#999')
...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\ist2_pres_detay_v4.svg"
