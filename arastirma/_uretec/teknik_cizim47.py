# -*- coding: utf-8 -*-
"""HAT v47 (v46 + TOPPING kap simgesi v26 Picnic tipi, ⑦ 15,4, ⑧ v26, robot ≈ 12 kap/hafta) — v46: TUM ISTASYONLAR SON VERSIYON (5 Eyl 2026): STORE v4 (+ v5 oneri: −18 kaset kati ustte, klapeli, 4 kap sol modul) ·
...
notew(cm2+px(230),ry-20,"uçlar: TEPSİ eli + PENÇE + ÇATAL (uç değiştirici PRESS kabininin altında) · kap değişimleri gece, haftada ≈ 12 + STORE→ALT 4",X0+px(T)-cm2-px(260),8.6,"#555","start")
...
rc(kx-10,ky-18,KW,px(1930),1.4,6,'#b3452b',None,'#fff8f5')
tx(kx,ky,"KONTROL — istasyonlar arası uyum (5 Eyl 2026, HAT v47)",12,"start","bold","#b3452b")
K=[
 ...
 ("⑦ KOL YÜKÜ YENİDEN AÇIK: kap boş ≈ 5,0 kg (PC 5 mm 3,3 + POM helezon 0,7 + tarak 1,0) + çatal 2,0 → kıyma 15,4 kg · sucuk 14,7 · kaşar 12,8","→ 12,5 kg kobot YETMEZ → 16–20 kg sınıfı + menzil ≥ 130 (CRX-20iA/L 142 · H2017 170 · TM20 130; UR16e 90 ✗) ya da kıyma/sucuk 2 günlük dolum (6 kg) — KARAR","#b3452b"),
 ...
 ("⑫ Pide Ø30 → tepsi Ø32 zinciri: PRESS plaka Ø29 ✓ · PACK bıçak Ø28 ✓ · OVEN 44 (②) · robot tepsi eli v1 (Ø34) → v2 GEREK","→ harçlar KAVRULMUŞ/SOTE vakumlu (çiğ olmaz) · açıklar: tırnak-cep hizası (pim + kamera) · −18 raf buzlanması · klape contaları · soğutma grubu ≤ 20 boy · v26: yayıcı plaka mı spiral süpürme mi · gramaj prototipi (123 cm³/dev) · PC çizilme","#9a6b1f"),
]
yy=ky+22
KWc=KW-24
for a_,b_,c_ in K:
...
tx(X0,Y0-72,"Robot: tek kol, 16–20 kg sınıfı (en ağır yük: kıyma kabı 8,4 + kap 5,0 + çatal 2,0 = 15,4 kg — ⑦ açık) · uç değiştirici: TEPSİ eli (pide press'ten kutuya kadar tepside, fırına tepsiyle) + PENÇE (hamur · kutu · içecek) + ÇATAL (kap, forklift gibi önden). Mavi = tepsi Ø32 (pide Ø30). Kırmızı = KONTROL bulgusu.",10,"start","","#333")
tx(X0,Y0-54,"Ölçüler cm. HER KABİN 70/65/140 × 197 × 84 (gövde 185 + ayak 12; TOPPING'de ayak yerine plint 12 = soğutma ızgarası). Açık: ② fırın kavitesi 44 · ⑤ Fersah Ø30 taban · ⑦ kol yükü 15,4 kg + menzil · ⑩ yağ pompa · ⑫ tepsi Ø32 zinciri (robot uç v2) · ① STORE v5 onayı · TOPPING prototipleri (spiral 11, kaşar akışı, çatal-cep hizası)",10,"start","","#333")

W=int(X0+px(T)+px(2200)); H=int(YT2+px(1990))
...
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\FULL_MAKINE\hat_on_gorunus_teknik_v47.svg"
