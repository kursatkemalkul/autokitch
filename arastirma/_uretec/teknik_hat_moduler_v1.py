# -*- coding: utf-8 -*-
"""AUTOKITCH - TABLALI HAT · MODULER v1 (14 Eyl 2026): ON + UST GORUNUS. Olculer mm. SIFIRDAN CIZILDI.
Kemal: "her parca ayri modul, birlesince tum koseler esit, biri iceride biri disarida olmaz; en alttaki ayak kalksin".
KURAL: her istasyon kendi dolabi (W x 1915 x 830), alt depolama KENDI genisligi icinde; ust/alt/on/arka cizgiler hizali; ayak (kaide) YOK.
KURALLAR AYNEN: tam 3 gun (pide 240 · lahmacun 600 · icecek 210 · Atosa 1 gunluk set + 2 gunluk dolu yedek hazne seti) · 60/saat 4'lu firin
  · cekmece ayri + motorlu + robot ustten + top etrafi el payi · conta alini 33 (adim: pide 108 · lahmacun 93 · icecek 165 · yedek raf 418) · Atosa alti ray/motor payi 171.
HESAP (tam arama, modul ici kolon yukseklikleri: PRESS Hb-400 · TOPPING Hb-421 · OVEN Hb-440 · tam boy STORE 40..1660 = 1620):
  A) PRESS 670 | TOPPING 1310 (2 kolon) | OVEN 1420 | KESME 500 (alti TEKNIK) | PACK 700 -> hat 4600, tabla 1405, yukseklik 2075, Atosa yaninda 425 bos ust alan
  B) STORE tam boy 655 | PRESS 670 | TOPPING 885 | OVEN 1420 | KESME 500 (alti TEKNIK) | PACK 700 -> hat 4830, tabla 1245, yukseklik 1915  <- SECILDI
     (ust alanda olu bosluk yok, Atosa kapagi 1,9 m, yedek raflar insan boyunda)
DIZILIM (alttan uste): STORE raf1 · raf2 · 1 icecek · 4 pide · 2 lahm | PRESS 9 lahm | TOPPING raf3 · 2 pide · 2 lahm | OVEN-A 4 pide · 4 lahm | OVEN-B 3 icecek · 2 pide · 1 lahm.
Kural: paftada yalniz gorunus + olcu + parca adi; aciklama mesajda.
"""
import os, math
from PIL import Image, ImageDraw, ImageFont

OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_MODULER_v1_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 3800, 2650
S = 0.62
...
txt(OX, 60, "AUTOKITCH  ·  TABLALI HAT  ·  MODÜLER  v1", f38, INK)
txt(OX, 128, "ön görünüş + üst görünüş  ·  her istasyon ayrı dolap, birleşince üst/alt/ön/arka çizgiler hizalı  ·  ayak yok  ·  hat %s × %s × 830  ·  tabla / bant %s  ·  tam 3 gün stok  ·  ölçüler mm  ·  14 Eylül 2026" % (sayi(HAT), sayi(H), sayi(HB)), f13, GRAY)
...
txt(W_PX - 150, ly + 34, "HAT %s × %s × 830 · 6 modül · pide 12 çekmece (240) · lahmacun 18 (600) · içecek 4 (210) · yedek hazne rafı 3 · TEKNİK KESME altında" % (sayi(HAT), sayi(H)), f9, GRAY, "rm")

assert not os.path.exists(OUT), "moduler v1 zaten var — yeni numara ver"
im.save(OUT)
