...
K=[
 ...
 ("④ PACK bıçak Ø30 – tepsi iç Ø32 pay az · kesim önden İNCE: bölge 73 → 41 cm","→ bıçak yıldızı Ø28 + yuva pimleri; kazanılan yer şarjöre (80 → 96 kutu)","#9a6b1f"),
 ("⑤ PRESS üst plaka Ø40 → Ø29 (tepsi içinde basma)","→ Fersah'a kalıp/plaka sorusu; alt plaka üstünde tepsi ✓","#b3452b"),
 ("⑥ Tepsi havuzu ✓ ÇÖZÜLDÜ: PRESS'te 8 YATAY yuva (v5); dikey cep sığmıyordu","→ fırında 2 + kolda 1 + soğuyan 5; BEYİN en soğuğu verir; gün sonu yıkama","#1d7a4f"),
 ...
 ("⑩ Tepsi Ø34: press ✓ · sprey ✓ · kesim ✓ · kutu 32 iç ✓","→ tek uyumsuz yer fırın kavitesi (②)","#1d7a4f"),
...
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\FULL_MAKINE\hat_on_gorunus_teknik_v40.svg"
