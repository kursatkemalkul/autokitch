# -*- coding: utf-8 -*-
"""AUTOKITCH - A1 YERLESIM v3 (16 Eyl 2026): iki sabit Fairino robot. UST GORUNUS x2 (alt alta) + ORTAK ON GORUNUS.
...
v2'ye gore: sayfa yuksekligi artti, planlar cakismiyor, etiket ve lejant yerleri duzeldi.
Kural: paftada yalniz gorunus + olcu + parca adi; aciklama mesajda. Olculer mm.
"""
import os, math
from PIL import Image, ImageDraw, ImageFont

OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_A1_v3_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 5400, 3560
...
def plan(OX, OY, cfg):
    ...
    txt(rx, ry + 34, "FR5 · 922", f8, ACC, "mt")
...
# ======================= SAYFA =======================
txt(210, 92, "AUTOKITCH · A1 YERLEŞİM v3 · İKİ SABİT ROBOT", f34, INK)
