...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_2KOL_v15_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 6600, 3400
S = 0.62
...
# ======================= BASLIK =======================
txt(OX, 70, "AUTOKITCH  ·  HAT 2 KOL  ·  TEKNİK RESİM  v15  ·  TEPSİ SOKETLİ (ÇATAL YOK)  ·  TOPPING 1800  ·  İÇECEK + TATLI K3 ÜSTÜNDE  ·  DEPO K4'TE  ·  HAT 3900 × 2030", f38, INK)
...
kesik(X_D, 360.0, 640.0, 150.0, 330.0, "ROBOT KONTROL KUTUSU", INK, "245 × 180 × 45 · ray yanında")
satirlar(fx(X_D + 350), fy(430.0), "kablo: kutu → zemin → ray kablo zinciri → robot (~3 m)|üstü boş · 634 × 770 × 200", f8, GRAY)
