...
ICERIK
  · TOPPING_fizik_v7.usd        makinenin kendisi (534 parca, 14 eklem, gercek kutleler)
...
MAKINE = os.path.join(FIZ, "TOPPING_fizik_v7.usd")
CIKTI = os.path.join(FIZ, "TOPPING_IKIZ_v7.usd")
