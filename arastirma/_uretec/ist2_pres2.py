# -*- coding: utf-8 -*-
# IST.2 PRES — DETAY v2: uc istasyonu GERCEK boyuta kuculdu (~50x35)
...
tx(X0,Y0-96,'İSTASYON 2 — PRES · DETAY ÇİZİMİ v2',17,'start','bold')
...
rc(X0+px(80),Y0+px(300),px(500),px(360),1.6,4)
tx(X0+px(330),Y0+px(345),'ROBOT UÇ İSTASYONU (dock) — GERÇEK BOYUT ~50×35',10,'middle','bold')
# cep 1: kurek (changer plakasi Ø7-8 -> 80mm)
rc(X0+px(150),Y0+px(390),px(110),px(36),1.2,2)         # pin plakasi (kucuk)
ln(X0+px(165),Y0+px(426),X0+px(165),Y0+px(455),1.1); ln(X0+px(245),Y0+px(426),X0+px(245),Y0+px(455),1.1)
rc(X0+px(105),Y0+px(468),px(200),px(22),1.3,2)         # kurek yuzu
not_(X0+px(205),Y0+px(530),'CEP 1: kürek ucu')
# cep 2: yedek pence
rc(X0+px(400),Y0+px(390),px(110),px(36),1.2,2)
ln(X0+px(415),Y0+px(426),X0+px(415),Y0+px(455),1.1); ln(X0+px(495),Y0+px(426),X0+px(495),Y0+px(455),1.1)
ln(X0+px(425),Y0+px(468),X0+px(455),Y0+px(525),1.3); ln(X0+px(485),Y0+px(468),X0+px(455),Y0+px(525),1.3)
not_(X0+px(455),Y0+px(560),'CEP 2: yedek el')
not_(X0+px(330),Y0+px(610),'kilit plakası Ø7-8 · pin+burç · "uç var" sensörü — robot takar/bırakır')
# ust bosluk
not_(X0+px(330),Y0+px(760),'BOŞ — büyüme payı (3. cep eklenebilir)')
...
# uc istasyonu yan
rc(sx+px(120),Y0+px(300),px(400),px(360),1.4,4)
tx(sx+px(320),Y0+px(490),'uç istasyonu',9.5)
...
tx(W-24,H-14,'AUTOKITCH · ist2_pres_detay_v2',10,'end','','#999')
...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\ist2_pres_detay_v2.svg"
