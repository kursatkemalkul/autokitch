# -*- coding: utf-8 -*-
"""AUTOKITCH - TABLALI HAT · MODULER v6 · HER SEY 1 GUN · ATOSA KASETI (14 Eyl 2026): ON + UST GORUNUS. Olculer mm.
Kemal: "kasetleri Atosa'daki kaset olcusunde yap; kasar ve digerleri kac kasete bolunmesi gerekirse bol."
ATOSA KASETI: brosur topping haznesi 6 lb = 2,72 kg -> 0,58 kg/L ile 4,7 L; genislik fotograftan ~108; derinlik 250 (sira), yukseklik 360 (hazne bolmesi) -> 108 x 250 x 360.
  (brosurdeki buyuk hazneler sos 26,5 lb = 12 kg, peynir 22 lb = 10 kg artik yok; hepsi ayni kaset)
DOLUM: en cok %90 (tasma payi) = 4,2 L/kaset. 1 gun: HARC 21,6 kg (1,0 kg/L) -> 6 kaset x 3,6 kg · KIYMA 3,2 kg -> 1 · KUSBASI 2,9 kg (0,58) -> 2 x 1,45 kg
  · KASAR 4,4 kg (0,40 -> 11 L) -> 3 x 1,47 kg · SUCUK 1,4 kg (0,58) -> 1 = 13 kaset. (HARC 5 kasete %92 dolar, pay kalmaz)
SIRA: on 7 (HARC 6 + KIYMA) · arka 6 (KASAR 3 + KUSBASI 2 + SUCUK); 7 x 108 + 6 x 8 = 804 <= 815. Geri kalan her sey MODULER v5 ile ayni.
Kural: paftada yalniz gorunus + olcu + parca adi; aciklama mesajda.
"""
import os, math
from PIL import Image, ImageDraw, ImageFont

OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_MODULER_v6_hersey1gun_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 3800, 2460
S = 0.62
...
txt(OX, 60, "AUTOKITCH  ·  TABLALI HAT  ·  MODÜLER  v6  ·  HER ŞEY 1 GÜN  ·  ATOSA KASETİ", f38, INK)
txt(OX, 128, "ön görünüş + üst görünüş  ·  her istasyon ayrı dolap, birleşince üst/alt/ön/arka çizgiler hizalı  ·  ayak yok  ·  hat %s × %s × 830  ·  tabla / bant %s  ·  her şey 1 gün  ·  13 Atosa kaseti  ·  ölçüler mm  ·  14 Eylül 2026" % (sayi(HAT), sayi(H), sayi(HB)), f13, GRAY)
...
txt(W_PX - 150, ly + 34, "HAT %s × %s × 830 · 5 modül · pide 4 çekmece (80) · lahmacun 6 (200) · içecek 2 dar çekmece (70) · şarjör 280 blank · 13 Atosa kaseti: HARÇ 6 · KIYMA 1 · KUŞBAŞI 2 · KAŞAR 3 · SUCUK 1 · soğutma grubu PRESS altında · hat panosu TOPPING altında" % (sayi(HAT), sayi(H)), f9, GRAY, "rm")

assert not os.path.exists(OUT), "moduler v6 zaten var — yeni numara ver"
im.save(OUT)
