...
# ---------- adlar ----------
for a, b in (("kasar_kabi_v8", "kiyma_kaseti_v2"), ("KASAR_KABI_v8", "KIYMA_KASETI_v2"), ("kasar_v8", "kiyma_v2"), ("kasar_cad_v8", "kiyma_cad_v2")):
    s = s.replace(a, b)

# ---------- başlık ----------
i = s.index('"""'); j = s.index('"""', i + 3) + 3
s = s[:i] + '''"""AUTOKITCH · KIYMA KASETİ v2 — ÜRETİM MODELİ (22 Eyl 2026) · kasar_cad_v8 mimarisinden türetildi (yap_kiyma_v2.py)
...
'''
n[0] += 1
io.open(os.path.join(U, "kiyma_cad_v2.py"), "w", encoding="utf-8").write(s)
print("kiyma_cad_v2.py yazildi ·", n[0], "yama")
