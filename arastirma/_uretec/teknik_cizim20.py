...
ln(am,Y0+px(10),am,Y0+px(300),1.4)
ci(a0+px(180),Y0+px(140),px(75),1.2); ci(a0+px(520),Y0+px(140),px(75),1.2)
ln(a0+px(145),Y0+px(105),a0+px(215),Y0+px(175),.9); ln(a0+px(145),Y0+px(175),a0+px(215),Y0+px(105),.9)
ln(a0+px(485),Y0+px(105),a0+px(555),Y0+px(175),.9); ln(a0+px(485),Y0+px(175),a0+px(555),Y0+px(105),.9)
for g in range(4): ln(a0+20,Y0+px(225)+g*px(15),am-20,Y0+px(225)+g*px(15),.7)
ln(am+10,Y0+px(155),a1-12,Y0+px(155),1)
for i in range(4): rc(am+px(30)+i*px(160),Y0+px(35),px(135),px(105),1,2)
for i in range(5): rc(am+px(25)+i*px(130),Y0+px(175),px(110),px(110),1,2)
...
not_((a0+am)/2,Y0+px(58),"soğutma ×2 (sol yarı)")
not_((am+a1)/2,Y0+px(24),"KURU SARF — ÜST RAF (insan bölgesi, robot gitmez): saçet · peçete · teneke · karton")
not_((a0+am)/2,Y0+px(345),"DONMUŞ −18° · 4 raf × 20 = 80 — 1 GÜNLÜK")
not_((a0+am)/2,Y0+px(1480),"BOŞ — büyüme payı (donmuş +2-4 raf yeri)")
...
tx(X0,Y0-70,"AUTOKITCH — HAT v20 · SOĞUK DEPO 2 KAPI · 415 × 197 × 84 cm",15,"start","bold")
tx(X0,Y0-50,"ölçüler cm · KURU SARF ÜST BANTTA (motor yanı — robotun işi olan her şey aşağıda) · ılık 4 · TAZE 160=2G · DONMUŞ 80=1G · içecek 122 · tatlı 20 · ayak 12",10.5,"start")

W=int(X0+px(T)+110); H=int(YT2+px(1860))
svg=(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">'
     f'<rect width="{W}" height="{H}" fill="#ffffff"/>'+''.join(E)+'</svg>')
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\hat_on_gorunus_teknik_v20.svg"
