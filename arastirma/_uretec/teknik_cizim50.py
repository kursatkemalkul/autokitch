...
_ki=len(E)
tx(kx,ky,"KONTROL — istasyonlar arası uyum (6 Eyl 2026, HAT v50)",12,"start","bold","#b3452b")
K=[
...
tx(X0,Y0-94,"AUTOKITCH — HAT v50 · TÜM İSTASYONLAR SON VERSİYON (6 Eyl 2026) — STORE v4 (+ v5 öneri) · PRESS v8 · TOPPING v25 yerleşim + v27 KAP · OVEN v5 (Omake 2 kat · 1 STANDART YAĞ KABI + sprey ortada · KESME PRESİ · kolon 70) · PACK = şarjör 116 + kutulama",15,"start","bold")
...
OUT=r"C:\Users\Kemal\Desktop\Kemal\WEBSİTE\AUTOKITCH\arastirma\FULL_MAKINE\hat_on_gorunus_teknik_v50.svg"
