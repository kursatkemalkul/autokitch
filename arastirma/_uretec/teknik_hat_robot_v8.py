# -*- coding: utf-8 -*-
"""AUTOKITCH - HAT v8 (16 Eyl 2026): iki robot, bant yok, 3 gozlu kaviteli firin (2 lahmacun alt alta + 1 pide).
...
OUT = r"C:\Users\Kemal\Desktop\Kemal\WEBSITE\AUTOKITCH\arastirma\FULL_MAKINE\HAT_ROBOT_v8_teknik.png".replace("WEBSITE", "WEBS\u0130TE")
W_PX, H_PX = 5200, 2960
...
# ======================= SAYFA =======================
txt(210, 92, "AUTOKITCH · HAT v8 · İKİ ROBOT · 3 GÖZLÜ FIRIN", f34, INK)
