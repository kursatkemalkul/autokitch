...
1 numaralı kural: her şey hesaplanacak. Model (topping_cad_v2.py) bu dosyadan OKUR, sayı iki yerde yazılmaz.
...
if __name__ == "__main__":
    ...
    with io.open(os.path.join(U, "topping_hesap_v2.json"), "w", encoding="utf-8") as f:
        json.dump(S, f, ensure_ascii=False, indent=1)
    print("topping_hesap_v2.json yazildi")
